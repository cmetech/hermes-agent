...
def is_container() -> bool:
    """Compatibility delegate for shared container-runtime detection."""
    from hermes_cli.container_storage import is_container as detect_container
