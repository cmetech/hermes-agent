...
class TestConcurrentToolExecution:
    ...
    def test_sequential_registry_tool_forwards_request_middleware_trace(
        ...
        monkeypatch.setattr(
            ...
            lambda *_args, **_kwargs: SimpleNamespace(
                block_message=None, admission=None, modified_args=None
            ),
        )
        monkeypatch.setattr(
    ...
    def test_sequential_blocked_tool_skips_checkpoints_and_callbacks(self, agent, monkeypatch):
        ...
        monkeypatch.setattr(
            ...
            lambda *args, **kwargs: SimpleNamespace(
                block_message="Blocked by policy", admission=None, modified_args=None
            ),
        )
    ...
    def test_blocked_memory_tool_does_not_reset_counter(self, agent, monkeypatch):
        ...
        monkeypatch.setattr(
            "hermes_cli.plugins.resolve_pre_tool_admission",
            lambda *args, **kwargs: SimpleNamespace(
                block_message="Blocked", admission=None, modified_args=None
            ),
        )
