...
export const zh = defineLocale({
  ...
  settings: {
    ...
    connectorPlugins: {
      title: '独立连接器',
      blurb: '配置可选的服务连接器。更改将在新对话中生效。',
      count: n => `${n} 个可配置`,
      loading: '正在加载独立连接器',
      loadFailed: '无法加载独立连接器',
      empty: '未安装可配置的独立连接器。',
      enabled: '已启用',
      disabled: '已禁用',
      ready: '就绪',
      ...
      secretSet: '密钥已设置',
      secretNotSet: '密钥未设置',
      saveField: field => `保存${field}`,
      setField: field => `设置${field}`,
      clearField: field => `清除${field}`,
      unsupportedField: field => `此版本无法编辑${field}。`,
      saveFailed: field => `保存${field}失败`,
      clearFailed: field => `清除${field}失败`,
      toggleFailed: plugin => `更改${plugin}失败`,
      readinessFailed: plugin => `刷新${plugin}就绪状态失败`,
      refreshReadiness: plugin => `刷新${plugin}的就绪状态`,
      enablePlugin: plugin => `启用${plugin}`,
      disablePlugin: plugin => `禁用${plugin}`,
      authenticationRequired: field => `需要身份验证：${field}`,
      configurationRequired: field => `需要配置：${field}`,
      invalidConfiguration: field => `配置无效：${field}`,
      setupRequired: action => `需要设置：${action}`,
      availableNextSession: '启用并开始新会话后可用。',
      actionFailed: action => `启动${action}失败`,
      actionStatusFailed: '检查设置状态失败',
      actionCancelFailed: '取消设置失败',
      checkActionStatus: '检查设置状态',
      cancelAction: '取消设置',
      actionStatuses: {
        cancelled: '设置已取消',
        failed: '设置失败',
    ...
    model: {
      ...
      automaticRouting: '自动路由',
      currentNeedsReview: '需要检查',
      grandfatheredWarning: '此已保存模型作为旧有配置保留，未进行更改。准备好后请选择已验证的模型。',
      refreshModels: '刷新模型',
      eligibilityReasons: {
        'authentication-required': 'Gateway 需要认证',
        'capability-response-invalid': '能力响应不兼容',
        'catalog-empty': '没有可用的具体模型',
        'gateway-unreachable': 'Gateway 不可用',
        'gateway-upgrade-required': '需要更新 Gateway',
        unknown: '模型状态未知',
        'automatic-not-allowed': '无法在此固定自动路由',
        'model-not-live': '已不在实时模型目录中',
        'completion-unknown': '尚未验证补全能力',
        'completion-unsupported': '不支持补全',
        'tools-unknown': '尚未验证工具支持',
        'tools-unsupported': '不支持工具',
        'vision-unknown': '尚未验证视觉支持',
        'vision-unsupported': '不支持视觉'
      },
      providerReadiness: {
        'authentication-required': '请在密钥页面配置 OTTO_API_KEY 以使用 Gateway 模型。',
        'capability-response-invalid': 'Gateway 返回了不兼容的能力响应。',
        'catalog-empty': 'Gateway 未返回具体模型。请刷新模型目录后重试。',
        'gateway-unreachable': 'Gateway 不可用。请刷新模型目录后重试。',
        'gateway-upgrade-required': '请更新 Gateway 以加载已验证的模型能力。',
        unknown: 'Gateway 模型状态未知。请刷新模型目录后重试。'
      },
      tasks: {
  ...
  operations: {
    workflowMarketplaceRetryCheck: '重试检查',
    workflowMarketplaceAbsent: '未安装此包。',
    workflowMarketplaceUnconfirmed: '无法确认状态。操作可能已完成。',
    workflowMarketplaceConflict: '另一个包操作正在运行。尚未开始更改。请刷新状态后重试。',
    workflowMarketplaceRecoveryRequired: '无法确认状态。需要恢复包事务。',
    workflowMarketplaceCancelledBeforeCommit: '已在提交更改前取消。',
    workflowMarketplaceRemovalCompleted: '包移除已完成。',
    workflowMarketplaceInstalledVersionResult: version => `已安装版本 ${version}。`,
    workflowMarketplaceUpdatedVersionResult: version => `已更新至版本 ${version}。`,
    workflowMarketplaceInstallationNoTrust: '安装不会授予信任。',
    workflowMarketplaceUntrustedRunRequirement: '运行未受信任的工作流需要先授予信任。',
    workflowMarketplaceUpdateAvailableResult: '有可用更新。',
    workflowMarketplaceCheckError: '无法检查更新。',
    workflowMarketplaceOrphaned: '已安装包的来源不可用。',
    workflowMarketplaceCurrentlyInstalled: version => `当前已安装：${version}。`,
    workflowMarketplaceRolledBack: '更改已回滚。',
    workflowMarketplaceNoPackageChanges: '此次尝试未更改包。',
    workflowMarketplaceReviewUnavailable: '审查不可用。请重新准备审查。',
    workflowMarketplaceTrustOneGranted: name => `已为 ${name} 授予信任。`,
    workflowMarketplaceTrustAllGranted: '已为所有审查过的工作流授予信任。',
    workflowMarketplaceCurrentTrust: '当前包信任状态',
    workflowMarketplaceUnconfirmedRefresh: '无法确认状态。请刷新包状态后重试。',
    workflowMarketplaceRefreshingState: '正在刷新包状态',
    workflowMarketplaceLastObservedRefreshing: '上次观察结果 — 正在刷新包状态',
    workflowMarketplaceLastObservedPrefix: '上次观察结果：',
    workflowMarketplaceAbsentLastObserved: '包不存在。显示上次观察到的元数据',
    workflowMarketplaceRecoveryUnconfirmed: '需要恢复。包状态尚未确认。',
    workflowMarketplaceRefreshState: '刷新状态',
    workflowMarketplaceLastObservedSearch: '上次观察到的搜索元数据',
    workflowMarketplaceRecoveryCatalog: '需要恢复。显示上次观察到的目录。',
    workflowMarketplaceBusyCatalog: '包操作正在进行。显示上次观察到的目录。',
    workflowMarketplaceUnconfirmedCatalog: '包状态尚未确认。显示上次观察到的目录。',
    workflowMarketplace: '市场',
    workflowMarketplaceCapabilityLoading: '正在检查工作流市场可用性',
    workflowMarketplaceUpgradeTitle: '升级 Hermes 以使用工作流市场',
    workflowMarketplaceUpgradeDescription:
      '此后端尚不支持工作流包。请升级 Hermes；已安装、活动、历史和归档视图仍可使用。',
    workflowMarketplaceAuthTitle: '登录以浏览工作流包',
    workflowMarketplaceAuthDescription: '此后端要求身份验证后才能读取工作流市场。',
    workflowMarketplaceErrorTitle: '无法加载工作流市场',
    workflowMarketplaceErrorDescription: '市场后端暂时不可用。请重试。',
    workflowMarketplaceSearch: '搜索工作流包',
    workflowMarketplaceSource: '来源',
    workflowMarketplaceAllSources: '所有来源',
    workflowMarketplaceDisabledSource: source => `${source}（已禁用）`,
    workflowMarketplaceLoading: '正在加载工作流包',
    workflowMarketplaceCatalogErrorTitle: '无法加载工作流包',
    workflowMarketplaceCatalogErrorDescription: '包目录暂时不可用。请重试。',
    workflowMarketplaceSourceAuthTitle: '来源需要身份验证',
    workflowMarketplaceSourceDisabledTitle: '此工作流来源已禁用',
    workflowMarketplaceEmptyTitle: '没有可用的工作流包',
    workflowMarketplaceEmptyDescription: '添加或刷新来源以获取工作流包。',
    workflowMarketplaceNoMatchTitle: '没有与搜索匹配的包',
    workflowMarketplaceNoMatchDescription: '尝试其他包名、发布者、标签或来源。',
    workflowMarketplaceStale: '来源已过期',
    workflowMarketplaceStaleLabel: '已过期的市场结果',
    workflowMarketplaceStaleDescription: '部分来源目录已过期。当前显示已验证的缓存包，结果可能不完整。',
    workflowMarketplacePackages: '工作流包',
    workflowMarketplacePagination: '工作流包分页',
    workflowMarketplacePreviousPage: '上一页',
    workflowMarketplaceNextPage: '下一页',
    workflowMarketplacePage: page => `第 ${page} 页`,
    workflowMarketplaceSelectTitle: '选择工作流包',
    workflowMarketplaceSelectDescription: '选择一个包以检查已验证的内容和要求。',
    workflowMarketplaceBack: '返回包列表',
    workflowMarketplaceDetailLoading: '正在加载工作流包详情',
    workflowMarketplaceDetailErrorTitle: '无法检查此包',
    workflowMarketplaceDetailErrorDescription: '无法加载最新的已验证包详情。请重试。',
    workflowMarketplaceDetailLabel: name => `${name} 包详情`,
    workflowMarketplaceCurrent: '当前',
    workflowMarketplaceInstalled: '已安装',
    workflowMarketplaceInstalledVersion: version => `已安装 v${version}`,
    workflowMarketplaceInstalledStatusLoading: '正在加载已安装包状态',
    workflowMarketplaceInstalledStatusUnavailableTitle: '已安装包状态不可用',
    workflowMarketplaceInstalledStatusUnsupportedDescription: '此后端不提供已安装包状态，浏览结果可能不显示安装标记。',
    workflowMarketplaceInstalledStatusAuthTitle: '登录以比较已安装包',
    workflowMarketplaceInstalledStatusAuthDescription: '比较已安装的市场包需要身份验证。',
    workflowMarketplaceInstalledStatusErrorDescription: '无法加载已安装包状态，浏览结果可能不显示安装标记。',
    workflowMarketplaceInstalledProvenanceLoading: '正在加载已安装包来源记录',
    workflowMarketplaceInstalledProvenanceUnavailableTitle: '已安装包来源记录不可用',
    workflowMarketplaceInstalledProvenanceUnsupportedDescription: '此后端不提供市场包来源记录。独立工作流仍可使用。',
    workflowMarketplaceInstalledProvenanceAuthTitle: '登录以加载已安装包来源记录',
    workflowMarketplaceInstalledProvenanceAuthDescription: '加载已安装市场包的来源记录需要身份验证。',
    workflowMarketplaceInstalledProvenanceErrorTitle: '无法加载已安装包来源记录',
    workflowMarketplaceInstalledProvenanceErrorDescription: '已安装市场包来源记录暂时不可用。独立工作流仍可使用。',
    workflowMarketplaceUpdateAvailable: '有可用更新',
    workflowMarketplacePublisher: '发布者',
    workflowMarketplaceLicense: '许可证',
    workflowMarketplaceCandidateIdentity: '候选包标识',
    workflowMarketplacePackageDigest: '包摘要',
    workflowMarketplacePackagePath: '包路径',
    workflowMarketplaceInstalledProvenance: '已安装包来源记录',
    workflowMarketplaceInstalledIdentity: '安装标识',
    workflowMarketplaceInstalledVersionLabel: '已安装版本',
    workflowMarketplaceInstalledSource: '安装来源',
    workflowMarketplaceInstalledRepository: '安装仓库',
    workflowMarketplaceInstalledRef: '已安装 Git 引用',
    workflowMarketplaceInstalledCommit: '已安装提交',
    workflowMarketplaceDistributionDigest: '分发摘要',
    workflowMarketplaceInstalledAt: '安装时间',
    workflowMarketplaceInstalledPackagePath: '已安装包路径',
    workflowMarketplaceRepository: '仓库',
    workflowMarketplaceRef: 'Git 引用',
    workflowMarketplaceDefaultRef: '默认分支',
    workflowMarketplaceCommit: '提交',
    workflowMarketplaceVerified: '已验证',
    workflowMarketplaceBlockers: '兼容性阻碍',
    workflowMarketplaceAdvisories: '提示',
    workflowMarketplaceCompatibility: '工作流兼容性',
    workflowMarketplaceWorkflowCount: count => `${count} 个工作流`,
    workflowMarketplaceCommands: '命令',
    workflowMarketplaceScripts: '脚本',
    workflowMarketplaceMcpResources: 'MCP 资源',
    workflowMarketplaceOtherResources: '其他共享资源',
    workflowMarketplaceRequirements: '外部要求',
    workflowMarketplaceProviders: '提供商',
    workflowMarketplaceRuntimes: '运行时',
    workflowMarketplaceSecrets: '密钥',
    workflowMarketplaceServices: '服务',
    workflowMarketplaceTools: '工具',
    workflowMarketplaceNoRequirements: '没有外部要求。',
    workflowMarketplaceInstalledPackages: '已安装的市场包',
    workflowMarketplaceSourceUnavailable: '来源不可用',
    workflowMarketplaceManageSources: '管理来源',
    workflowMarketplaceRefresh: '刷新',
    workflowMarketplaceRefreshAll: '全部刷新',
    workflowMarketplaceSourcesTitle: '工作流来源',
    workflowMarketplaceSourcesDescription: '配置不含凭据的 Git 仓库标识。身份验证由 Git 凭据助手或 SSH 配置管理。',
    workflowMarketplaceAddSource: '添加来源',
    workflowMarketplaceEditSource: source => `编辑 ${source}`,
    workflowMarketplaceRemoveSource: source => `移除 ${source}`,
    workflowMarketplaceRemoveSourceAction: '移除来源',
    workflowMarketplaceRemovingSource: '正在移除来源…',
    workflowMarketplaceEnableSource: source => `启用 ${source}`,
    workflowMarketplaceDisableSource: source => `禁用 ${source}`,
    workflowMarketplaceEnableAction: '启用',
    workflowMarketplaceDisableAction: '禁用',
    workflowMarketplaceRefreshSource: source => `刷新 ${source}`,
    workflowMarketplaceSourceArticle: source => `来源 ${source}`,
    workflowMarketplaceSourceName: '来源名称',
    workflowMarketplaceRepositoryUrl: '仓库 URL',
    workflowMarketplaceGitRef: 'Git 引用（可选）',
    workflowMarketplaceSaveSource: '保存来源',
    workflowMarketplaceEnabled: '已启用',
    workflowMarketplaceDisabled: '已禁用',
    workflowMarketplaceDefaultBranch: '默认分支',
    workflowMarketplaceLastVerified: timestamp => `上次验证 ${timestamp}`,
    workflowMarketplaceLastAttempted: timestamp => `上次尝试 ${timestamp}`,
    workflowMarketplaceNeverVerified: '从未验证',
    workflowMarketplacePackageCount: count => `${count} 个已验证包`,
    workflowMarketplaceFresh: '最新',
    workflowMarketplaceAuthenticationRequired: '需要身份验证',
    workflowMarketplaceCancelled: '已取消',
    workflowMarketplaceIncompatible: '不兼容',
    workflowMarketplaceMalformed: '格式错误',
    workflowMarketplaceUnavailable: '不可用',
    workflowMarketplaceNeverRefreshed: '从未刷新',
    workflowMarketplaceRefreshStatusUnavailable: '刷新状态不可用',
    workflowMarketplaceOperationEvicted: '刷新状态已过期。来源数据已重新核对，请按需重试。',
    workflowMarketplaceRefreshResultsLabel: '工作流来源刷新结果',
    workflowMarketplaceRefreshResult: (source, state) => `来源 ${source}：${state}`,
    workflowMarketplaceAuthGuidance: '配置 Git 凭据助手、SSH 代理或配置、gh auth 或支持的环境凭据，然后重试。',
    workflowMarketplaceSafeError: '无法完成来源操作。请检查来源配置后重试。',
    workflowMarketplaceRemoveTitle: source => `移除 ${source}？`,
    workflowMarketplaceRemoveDescription: '已安装的包会保留。移除此来源可能导致无法发现后续更新。',
    workflowMarketplaceSourceRemoved: '来源已移除',
    workflowMarketplaceUnsupportedSources: '升级 Hermes 以管理和刷新工作流来源。',
    workflowMarketplaceReviewInstallation: '审查安装',
    workflowMarketplaceReviewInstallationDescription: '安装前审查经过验证的确切包内容、要求和执行风险。',
    workflowMarketplaceReviewUpdate: '审查更新',
    workflowMarketplaceReviewUpdateDescription: '更新前将已安装包与经过验证的确切候选包进行比较。',
    workflowMarketplaceReviewRemoval: '审查移除',
    workflowMarketplaceReviewRemovalDescription: '继续前审查确切的已安装包和移除范围。',
    workflowMarketplaceReviewTrust: '审查信任',
    workflowMarketplaceReviewTrustDescription: '信任与安装是独立操作。授予信任前请审查已安装内容和确切的工作流风险。',
    workflowMarketplacePreparingInstallation: '正在准备安装审查',
    workflowMarketplacePreparingUpdate: '正在准备更新审查',
    workflowMarketplaceCheckingUpdates: '正在检查更新',
    workflowMarketplacePreparingRemoval: '正在准备移除审查',
    workflowMarketplacePreparingTrust: '正在准备信任审查',
    workflowMarketplaceOperationProgress: (phase, progress) => `进度 ${phase} ${progress}%`,
    workflowMarketplaceCancelOperation: '取消操作',
    workflowMarketplaceConfirmInstall: '确认安装',
    workflowMarketplaceConfirmUpdate: '确认更新',
    workflowMarketplaceConfirmRemoval: '移除包',
    workflowMarketplaceGrantTrust: '授予信任',
    workflowMarketplacePrepareAgain: '重新准备',
    workflowMarketplaceRetryStatus: '重试状态查询',
    workflowMarketplaceReviewDigest: '审查摘要',
    workflowMarketplaceCandidateVersion: '候选版本',
    workflowMarketplaceCandidateCommit: '候选提交',
    workflowMarketplaceCandidateDigest: '候选摘要',
    workflowMarketplacePreviousVersion: '先前版本',
    workflowMarketplacePreviousCommit: '先前提交',
    workflowMarketplacePreviousDigest: '先前摘要',
    workflowMarketplaceChangedFiles: '已更改文件',
    workflowMarketplacePhaseUnknown: '未知阶段',
    workflowMarketplacePhaseQueued: '排队中',
    workflowMarketplacePhaseRunning: '运行中',
    workflowMarketplacePhaseFetching: '获取中',
    workflowMarketplacePhaseReviewing: '审查中',
    workflowMarketplacePhaseValidating: '验证中',
    workflowMarketplacePhaseCommitting: '提交更改中',
    workflowMarketplacePhaseRecovering: '恢复中',
    workflowMarketplacePhaseCompleted: '已完成',
    workflowMarketplacePhaseFailed: '已失败',
    workflowMarketplacePhaseCancelled: '已取消',
    workflowMarketplacePhaseChecking: '检查更新中',
    workflowMarketplaceChangeAdded: '已添加',
    workflowMarketplaceChangeModified: '已修改',
    workflowMarketplaceChangeRemoved: '已移除',
    workflowMarketplaceChangeRenamed: '已重命名',
    workflowMarketplaceSeverityBlocker: '阻止项',
    workflowMarketplaceSeverityAdvisory: '提示',
    workflowMarketplaceDiagnosticLegacyLanguage: '工作流使用宽松的旧版 Hermes 语言规则。',
    workflowMarketplaceDiagnosticLegacyIdleTimeout: '旧版空闲超时按秒解释。',
    workflowMarketplaceDiagnosticMissingProvider: '所需提供商不可用。',
    workflowMarketplaceDiagnosticMissingRuntime: '所需运行时不可用。',
    workflowMarketplaceDiagnosticMissingSecret: '所需密钥不可用。',
    workflowMarketplaceDiagnosticMissingService: '所需服务不可用。',
    workflowMarketplaceDiagnosticMissingTool: '所需工具不可用。',
    workflowMarketplaceDiagnosticUnknown: 'Hermes 报告了此版本尚无翻译说明的兼容性问题。',
    workflowMarketplaceDiagnosticTechnicalDetails: '技术详情',
    workflowMarketplaceDiagnosticCode: '诊断代码',
    workflowMarketplaceDiagnosticMessage: '后端消息',
    workflowMarketplaceFileChange: (kind, path) => `变更 ${kind}：${path}`,
    workflowMarketplaceRenamedFrom: path => `原名 ${path}`,
    workflowMarketplacePackageResources: '包资源',
    workflowMarketplaceWorkflowRisks: '工作流风险',
    workflowMarketplaceDefinitionPath: '定义',
    workflowMarketplaceCompanionPath: '伴随文件',
    workflowMarketplaceRiskDigest: '风险摘要',
    workflowMarketplaceShellScriptNodes: 'Shell 或脚本节点',
    workflowMarketplaceScriptResources: '脚本资源',
    workflowMarketplaceCommandNodes: '命令节点',
    workflowMarketplaceCommandResources: '命令资源',
    workflowMarketplaceLocalMcp: '本地 MCP 服务器',
    workflowMarketplaceRemoteMcp: '远程 MCP 服务器',
    workflowMarketplaceMcpDefinitions: 'MCP 定义',
    workflowMarketplaceMcpResourceFiles: 'MCP 资源文件',
    workflowMarketplaceRequestedSkills: '请求的技能',
    workflowMarketplaceOutwardActions: '对外操作节点',
    workflowMarketplaceApprovalNodes: '审批节点',
    workflowMarketplaceRequiredSecrets: '所需密钥',
    workflowMarketplaceWorkflowChanges: '工作流成员变更',
    workflowMarketplaceRequirementChanges: '外部要求变更',
    workflowMarketplaceRiskChanges: '风险标识变更',
    workflowMarketplaceCompatibilityChanges: '兼容性变更',
    workflowMarketplaceAdded: '已添加',
    workflowMarketplaceRemoved: '已移除',
    workflowMarketplaceNoChanges: '没有变更。',
    workflowMarketplaceInstalledTrustRequired: '已安装 — 运行前需要信任',
    workflowMarketplaceUpdatedTrustRequired: version => `已更新至版本 ${version} — 运行前需要信任`,
    workflowMarketplaceReviewTrustAction: '审查信任',
    workflowMarketplaceInstallFailed: '安装失败。未安装新内容。',
    workflowMarketplaceInstallCancelled: '安装已取消。未安装新内容。',
    workflowMarketplaceUpdateFailed: '更新失败。',
    workflowMarketplaceUpdateCancelled: '更新已取消。',
    workflowMarketplaceVersionRemainsInstalled: version => `版本 ${version} 仍已安装。`,
    workflowMarketplaceNothingInstalled: '未安装新内容。',
    workflowMarketplaceOperationStatusLost: '操作状态已过期。请刷新包状态或重新准备。',
    workflowMarketplaceOperationStatusUnavailable: '操作状态暂时不可用。请重试。',
    workflowMarketplaceReviewStale: '审查已过期或变更。请重新准备审查后继续。',
    workflowMarketplacePackageCurrent: version => `版本 ${version} 已是最新。未安装更新。`,
    workflowMarketplaceTrustAllWorkflows: '所有工作流',
    workflowMarketplaceTrustOneWorkflow: '单个工作流',
    workflowMarketplaceSelectWorkflow: '选择工作流',
    workflowMarketplaceTrustNotGranted: '未授予信任。请重新准备信任审查。',
    workflowMarketplaceTrustGranted: '已为审查过的已安装内容授予信任。',
    workflowMarketplaceRemovalScope: '仅移除此命名空间中的包、来源记录及由此安装授予的信任。',
    workflowMarketplaceRemovalPreserves: '来源定义、其他包、独立工作流以及独立或手动授予的信任会保留。',
    workflowMarketplacePackageRemoved: '包已移除。',
    workflowMarketplaceRemovalFailed: '移除失败。',
    workflowMarketplaceRemovalCancelled: '移除已取消。',
    workflowMarketplaceInstallPackage: '安装包',
    workflowMarketplaceUpdatePackage: '更新包',
    workflowMarketplaceCheckUpdates: '检查更新',
    workflowMarketplaceRemovePackage: '移除包',
    workflowMarketplaceInstalledPackageLabel: identifier => `已安装包 ${identifier}`,
    workflowMarketplaceLifecycleUnavailable: '升级 Hermes 以管理已安装的工作流包。',
    workflows: '工作流',
    workflowViews: '工作流视图',
    workflowCatalog: '工作流目录',
    workflowCatalogLoading: '正在加载工作流目录',
    workflowCatalogErrorTitle: '无法加载工作流',
    workflowCatalogErrorDescription: '工作流目录暂时不可用。',
    workflowCatalogRetry: '重试',
    workflowCatalogEmptyTitle: '未安装工作流',
    workflowCatalogEmptyDescription: '安装工作流包后，它将显示在这里。',
    workflowCatalogDocs: '工作流文档',
    workflowCatalogPartialLabel: '部分工作流目录',
    workflowCatalogPartialDescription: '只能加载工作流目录的一部分。',
    workflowCatalogCapacityError: '已超出目录容量',
    workflowCatalogInvalidDefinition: '工作流定义无效',
    workflowCatalogFilter: '筛选工作流',
    workflowCatalogGoToPage: page => `转到工作流第 ${page} 页`,
    workflowCatalogNoMatchTitle: '没有与筛选条件匹配的工作流',
    workflowCatalogRange: (start, end, total) => `${start}–${end} / 共 ${total} 个工作流`,
    workflowCatalogRowsPerPage: '每页行数',
    workflowColumnName: '名称',
    workflowColumnVersion: '版本',
    workflowColumnDescription: '说明',
    workflowColumnTrust: '信任',
    workflowColumnInputs: '输入',
    workflowColumnSource: '来源',
    workflowColumnActions: '操作',
    workflowTrusted: '可信',
    workflowUntrusted: '不可信',
    workflowVerifiedBundle: '已验证捆绑包',
    workflowIncompatible: '不兼容',
    workflowLanguage: '工作流语言',
    workflowLanguageArchon: 'Archon 2026-07',
    workflowLanguageLegacy: '旧版语义',
    workflowLanguageLegacyDescription: '现有 Hermes 行为会保留。迁移到 Archon 2026-07 前，请检查兼容性结果。',
    workflowLanguageNormalizer: '规范化版本',
    workflowLanguageDigest: '规范化摘要',
    workflowDependencies: '工作流依赖项',
    workflowDependencySources: '依赖项来源',
    workflowDependencyPrecedence: '优先级',
    workflowDependencyPackages: '依赖包',
    workflowExpandedNodes: '展开的节点',
    workflowExpandedEdges: '展开的边',
    workflowIncludeDepth: '包含深度',
    workflowCompositeDigest: '组合摘要',
    workflowIgnoredPolicies: '已忽略的子策略',
    ...
    workflowSourceProject: '项目',
    workflowSourceBundled: '捆绑展示',
    workflowView: '查看',
    workflowViewTitle: workflow => `查看 ${workflow}`,
    workflowViewDescription: '在不更改或启动工作流的情况下查看详情。',
    workflowViewDiagram: '流程图',
    workflowViewDefinition: '定义',
    workflowViewLoading: '正在加载工作流详情',
    workflowViewErrorTitle: '无法加载工作流详情',
    workflowViewErrorDescription: '无法加载工作流详情。请重试。',
    workflowViewNotFound: '此工作流已不再安装。',
    workflowViewDiagramTooLarge: '工作流过大，已省略流程图并显示大纲。',
    workflowViewDiagramOmitted: '已省略流程图并显示大纲。',
    workflowViewDefinitionTitle: '规范化定义',
    workflowViewDefinitionCaption: '这是已脱敏的规范化定义，并非磁盘上的源文件。',
    workflowViewCopyDefinition: '复制定义',
    workflowViewRunLoading: '工作流就绪状态加载完成前无法运行。',
    workflowViewRunError: '成功加载工作流就绪状态前无法运行。',
    workflowRun: '运行',
    workflowRunUnavailable: '无法运行',
    workflowRunUnsupportedInputs: '此工作流使用不受支持的输入字段，因此无法运行。',
    workflowRunShowcaseFromCli: '请从 CLI 运行此捆绑展示。',
    workflowRunShowcaseVerificationFailed: '无法验证捆绑展示，因此未启动。',
    ...
    workflowRunPreflightLoading: '正在检查工作流是否可运行',
    workflowRunPreflightErrorTitle: '无法检查此工作流',
    workflowRunPreflightErrorDescription: '无法检查工作流是否可运行。',
    workflowRunTrust: '信任结论',
    workflowRunRisk: '风险摘要',
    workflowRunInputs: '输入',
    workflowRunInputBytes: (used, limit) => `${used} / ${limit} 字节`,
    workflowRunInputTooLarge: (input, limit) => `${input} 不能超过 ${limit} 字节。`,
    workflowRunBundledFixture: '内置测试文件',
    workflowRunStart: '启动工作流',
    workflowRunAt: '运行时间',
    workflowRunLater: '稍后运行',
    workflowRunLaterDescription: '在所选本地日期和时间一次性运行此工作流。',
    workflowRunScheduleInvalid: '请选择未来的日期和时间。',
    workflowScheduled: '已安排',
    workflowScheduledAt: '计划运行时间',
    workflowScheduledLocal: '本地时间',
    workflowScheduledCanonical: '标准 UTC',
    workflowRunRetry: '重试',
    workflowRunStarted: '已启动',
    workflowRunAlreadyRunning: '已在运行 — 正在显示该运行',
    workflowRunConflict: '创建此次运行意图后，输入已发生变化。请关闭检查窗口并重试。',
    workflowRunCatalogSourceInvalid: '此工作流来源已不可用。请关闭检查窗口并重新选择。',
    workflowRunCoordinatorUnavailable: '后台协调器未运行 — 请稍后重试。',
    workflowRunIncompatible: '此工作流与当前 Hermes 运行时不兼容，无法启动。',
    workflowRunProviderAuthorityUnavailable: '提供商就绪状态已更改，请在启动前重新检查。',
    workflowProviderReadiness: '提供商就绪状态',
    workflowProviderAuthorityDigest: '权威摘要',
    workflowProviderCapabilityLevel: '能力级别',
    workflowProviderRoute: (node, provider, model) => `${node}: ${provider} · ${model}`,
    workflowRunNetworkError: '连接失败，无法启动此次运行。',
    workflowRunProfileUnavailable: '运行已启动，但无法打开其配置文件。请重试以定位该运行。',
    workflowRunValidationError: '工作流输入未被接受。',
    workflowRunRequiredInput: input => `${input} 为必填项。`,
    workflowRunUnsupportedCommand: workflow =>
      `应用暂不支持此工作流的输入 — 请使用 hermes workflow run ${workflow} 运行。`,
    activeBoard: '活动看板',
    ...
    kanban: '看板',
    needsAttention: '需要处理',
    workflowAttention: '需要处理的工作流',
    openWorkflowRun: workflow => `打开运行 ${workflow}`,
    attentionAge: (count, unit) => `${count}${unit === 'day' ? '天' : unit === 'hour' ? '小时' : '分钟'}前`,
    status: '状态',
    health: '健康状态',
    graphProgress: '图进度',
    ...
    recovery: '恢复',
    noEvidence: '没有已记录的证据',
    artifactOutputType: '输出类型',
    artifactMediaType: '媒体类型',
    artifactProducer: '生成节点',
    artifactWinningAttempt: '最终采用的尝试',
    artifactSize: '大小',
    artifactSizeBytes: size => `${size} 字节`,
    artifactSha256: 'SHA-256',
    artifactSchemaFingerprint: 'Schema 指纹',
    artifactProducedAt: '生成时间',
    artifactSession: '会话',
    artifactIntegrity: '完整性',
    artifactRecovery: '恢复状态',
    artifactUnavailable: '不可用',
    artifactPreview: '预览产物',
    artifactDownload: '下载产物',
    artifactDownloading: '正在下载产物',
    artifactLabel: identity => `产物：${identity}`,
    artifactPreviewFor: identity => `预览产物：${identity}`,
    artifactDownloadFor: identity => `下载产物：${identity}`,
    artifactDownloadingFor: identity => `正在下载产物：${identity}`,
    artifactDownloadCancelled: '下载已取消。',
    artifactDownloadErrorTitle: '无法下载产物',
    artifactDownloadErrorDescription: '下载失败，请重试。',
    artifactPreviewRegion: '产物预览',
    artifactPreviewLoading: '正在加载产物预览',
    artifactPreviewErrorTitle: '无法加载产物预览',
    artifactPreviewErrorDescription: '产物元数据仍然可用。你可以重试或下载产物。',
    artifactPreviewIncomplete: '受限预览并不完整。请下载产物以查看完整内容。',
    artifactTextPreviewTruncated: '当前显示受限预览。请下载产物以查看完整输出。',
    artifactDownloadOnly: '此媒体类型无法预览，但仍可下载。',
    acceptResult: '接受结果',
    continueWithFeedback: '提供反馈并继续',
    feedback: '反馈',
    provideInput: '提供输入',
    inputValue: '输入值',
    reconcile: '核对结果',
    reconciliationOutcome: '已观察到的结果',
    confirmedSucceeded: '确认成功',
