...
export const ja = defineLocale({
  ...
  settings: {
    ...
    connectorPlugins: {
      title: 'スタンドアロンコネクター',
      blurb: '任意のサービスコネクターを設定します。変更は新しい会話から適用されます。',
      count: n => `${n} 件設定可能`,
      loading: 'スタンドアロンコネクターを読み込み中',
      loadFailed: 'スタンドアロンコネクターを読み込めませんでした',
      empty: '設定可能なスタンドアロンコネクターはインストールされていません。',
      enabled: '有効',
      disabled: '無効',
      ready: '準備完了',
      notReady: '未準備',
      ...
      secretNotSet: 'シークレット未設定',
      saveField: field => `${field} を保存`,
      setField: field => `${field} を設定`,
      clearField: field => `${field} をクリア`,
      unsupportedField: field => `${field} はこのバージョンでは編集できません。`,
      saveFailed: field => `${field} の保存に失敗しました`,
      clearFailed: field => `${field} のクリアに失敗しました`,
      toggleFailed: plugin => `${plugin} の変更に失敗しました`,
      readinessFailed: plugin => `${plugin} の準備状態を更新できませんでした`,
      refreshReadiness: plugin => `${plugin} の準備状態を更新`,
      enablePlugin: plugin => `${plugin} を有効化`,
      disablePlugin: plugin => `${plugin} を無効化`,
      authenticationRequired: field => `認証が必要: ${field}`,
      configurationRequired: field => `設定が必要: ${field}`,
      invalidConfiguration: field => `無効な設定: ${field}`,
      setupRequired: action => `セットアップが必要: ${action}`,
      availableNextSession: '有効化して新しいセッションを開始すると利用できます。',
      actionFailed: action => `${action} の開始に失敗しました`,
      actionStatusFailed: 'セットアップ状態を確認できませんでした',
      actionCancelFailed: 'セットアップをキャンセルできませんでした',
      checkActionStatus: 'セットアップ状態を確認',
      cancelAction: 'セットアップをキャンセル',
      actionStatuses: {
  ...
  operations: {
    workflowMarketplaceRetryCheck: '確認を再試行',
    workflowMarketplaceAbsent: 'パッケージはインストールされていません。',
    workflowMarketplaceUnconfirmed: '状態を確認できませんでした。操作は完了している可能性があります。',
    workflowMarketplaceConflict:
      '別のパッケージ操作が実行中です。変更は開始されていません。状態を更新してから再試行してください。',
    workflowMarketplaceRecoveryRequired: '状態を確認できませんでした。パッケージの復旧が必要です。',
    workflowMarketplaceCancelledBeforeCommit: '変更の確定前にキャンセルされました。',
    workflowMarketplaceRemovalCompleted: 'パッケージの削除が完了しました。',
    workflowMarketplaceInstalledVersionResult: version => `バージョン ${version} をインストールしました。`,
    workflowMarketplaceUpdatedVersionResult: version => `バージョン ${version} に更新しました。`,
    workflowMarketplaceInstallationNoTrust: 'インストールによって信頼は許可されません。',
    workflowMarketplaceUntrustedRunRequirement: '未信頼のワークフローを実行するには信頼の許可が必要です。',
    workflowMarketplaceUpdateAvailableResult: '更新を利用できます。',
    workflowMarketplaceCheckError: '更新を確認できませんでした。',
    workflowMarketplaceOrphaned: 'インストール済みパッケージのソースを利用できません。',
    workflowMarketplaceCurrentlyInstalled: version => `現在インストール済み: ${version}。`,
    workflowMarketplaceRolledBack: '変更をロールバックしました。',
    workflowMarketplaceNoPackageChanges: 'この試行ではパッケージを変更していません。',
    workflowMarketplaceReviewUnavailable: '確認内容を取得できません。新しい確認を準備してください。',
    workflowMarketplaceTrustOneGranted: name => `${name} の信頼を許可しました。`,
    workflowMarketplaceTrustAllGranted: '確認したすべてのワークフローの信頼を許可しました。',
    workflowMarketplaceCurrentTrust: '現在のパッケージの信頼',
    workflowMarketplaceUnconfirmedRefresh:
      '状態を確認できませんでした。パッケージ状態を更新してから再試行してください。',
    workflowMarketplaceRefreshingState: 'パッケージ状態を更新中',
    workflowMarketplaceLastObservedRefreshing: '前回の情報 — パッケージ状態を更新中',
    workflowMarketplaceLastObservedPrefix: '前回の情報: ',
    workflowMarketplaceAbsentLastObserved: 'パッケージはありません。前回のメタデータです',
    workflowMarketplaceRecoveryUnconfirmed: '復旧が必要です。パッケージ状態は未確認です。',
    workflowMarketplaceRefreshState: '状態を更新',
    workflowMarketplaceLastObservedSearch: '前回の検索メタデータ',
    workflowMarketplaceRecoveryCatalog: '復旧が必要です。前回のカタログを表示しています。',
    workflowMarketplaceBusyCatalog: 'パッケージ操作中です。前回のカタログを表示しています。',
    workflowMarketplaceUnconfirmedCatalog: 'パッケージ状態は未確認です。前回のカタログを表示しています。',
    workflowMarketplace: 'マーケットプレイス',
    workflowMarketplaceCapabilityLoading: 'ワークフローマーケットプレイスを確認中',
    workflowMarketplaceUpgradeTitle: 'マーケットプレイスを使うには Hermes を更新してください',
    workflowMarketplaceUpgradeDescription:
      'このバックエンドはワークフローパッケージに未対応です。Hermes を更新してください。インストール済み、実行中、履歴、アーカイブは引き続き使えます。',
    workflowMarketplaceAuthTitle: 'パッケージを閲覧するにはログインしてください',
    workflowMarketplaceAuthDescription: 'このバックエンドのマーケットプレイスを閲覧するには認証が必要です。',
    workflowMarketplaceErrorTitle: 'マーケットプレイスを読み込めませんでした',
    workflowMarketplaceErrorDescription:
      'マーケットプレイスのバックエンドは一時的に利用できません。再試行してください。',
    workflowMarketplaceSearch: 'ワークフローパッケージを検索',
    workflowMarketplaceSource: 'ソース',
    workflowMarketplaceAllSources: 'すべてのソース',
    workflowMarketplaceDisabledSource: source => `${source}（無効）`,
    workflowMarketplaceLoading: 'ワークフローパッケージを読み込み中',
    workflowMarketplaceCatalogErrorTitle: 'パッケージを読み込めませんでした',
    workflowMarketplaceCatalogErrorDescription: 'パッケージカタログは一時的に利用できません。再試行してください。',
    workflowMarketplaceSourceAuthTitle: 'ソースの認証が必要です',
    workflowMarketplaceSourceDisabledTitle: 'このワークフローソースは無効です',
    workflowMarketplaceEmptyTitle: '利用できるパッケージがありません',
    workflowMarketplaceEmptyDescription: 'ソースを追加または更新するとパッケージを利用できます。',
    workflowMarketplaceNoMatchTitle: '検索に一致するパッケージがありません',
    workflowMarketplaceNoMatchDescription: '別のパッケージ名、公開者、タグ、ソースで検索してください。',
    workflowMarketplaceStale: '古いソース情報',
    workflowMarketplaceStaleLabel: '古いマーケットプレイス情報',
    workflowMarketplaceStaleDescription:
      '一部のソースカタログが古くなっています。検証済みキャッシュを表示しているため、結果が不完全な場合があります。',
    workflowMarketplacePackages: 'ワークフローパッケージ',
    workflowMarketplacePagination: 'パッケージのページ送り',
    workflowMarketplacePreviousPage: '前のページ',
    workflowMarketplaceNextPage: '次のページ',
    workflowMarketplacePage: page => `ページ ${page}`,
    workflowMarketplaceSelectTitle: 'ワークフローパッケージを選択',
    workflowMarketplaceSelectDescription: 'パッケージを選び、検証済みの内容と要件を確認してください。',
    workflowMarketplaceBack: 'パッケージに戻る',
    workflowMarketplaceDetailLoading: 'パッケージ詳細を読み込み中',
    workflowMarketplaceDetailErrorTitle: 'このパッケージを検査できませんでした',
    workflowMarketplaceDetailErrorDescription: '最新の検証済み詳細を読み込めませんでした。再試行してください。',
    workflowMarketplaceDetailLabel: name => `${name} パッケージの詳細`,
    workflowMarketplaceCurrent: '最新',
    workflowMarketplaceInstalled: 'インストール済み',
    workflowMarketplaceInstalledVersion: version => `インストール済み v${version}`,
    workflowMarketplaceInstalledStatusLoading: 'インストール状態を読み込み中',
    workflowMarketplaceInstalledStatusUnavailableTitle: 'インストール状態を取得できません',
    workflowMarketplaceInstalledStatusUnsupportedDescription:
      'このバックエンドはインストール状態を公開していません。一覧にインストール済み表示がない場合があります。',
    workflowMarketplaceInstalledStatusAuthTitle: 'インストール済みパッケージを比較するにはログインしてください',
    workflowMarketplaceInstalledStatusAuthDescription: 'インストール済みパッケージの比較には認証が必要です。',
    workflowMarketplaceInstalledStatusErrorDescription:
      'インストール状態を読み込めませんでした。一覧にインストール済み表示がない場合があります。',
    workflowMarketplaceInstalledProvenanceLoading: 'インストール済みパッケージの来歴を読み込み中',
    workflowMarketplaceInstalledProvenanceUnavailableTitle: 'インストール済みパッケージの来歴を取得できません',
    workflowMarketplaceInstalledProvenanceUnsupportedDescription:
      'このバックエンドはパッケージの来歴を公開していません。単独のワークフローは引き続き使えます。',
    workflowMarketplaceInstalledProvenanceAuthTitle: '来歴を読み込むにはログインしてください',
    workflowMarketplaceInstalledProvenanceAuthDescription:
      'インストール済みパッケージの来歴を読み込むには認証が必要です。',
    workflowMarketplaceInstalledProvenanceErrorTitle: 'インストール済みパッケージの来歴を読み込めませんでした',
    workflowMarketplaceInstalledProvenanceErrorDescription:
      '来歴は一時的に取得できません。単独のワークフローは引き続き使えます。',
    workflowMarketplaceUpdateAvailable: '更新あり',
    workflowMarketplacePublisher: '公開者',
    workflowMarketplaceLicense: 'ライセンス',
    workflowMarketplaceCandidateIdentity: '候補パッケージの識別情報',
    workflowMarketplacePackageDigest: 'パッケージダイジェスト',
    workflowMarketplacePackagePath: 'パッケージパス',
    workflowMarketplaceInstalledProvenance: 'インストール済みパッケージの来歴',
    workflowMarketplaceInstalledIdentity: 'インストール識別情報',
    workflowMarketplaceInstalledVersionLabel: 'インストール済みバージョン',
    workflowMarketplaceInstalledSource: 'インストール元ソース',
    workflowMarketplaceInstalledRepository: 'インストール元リポジトリ',
    workflowMarketplaceInstalledRef: 'インストール済み Git 参照',
    workflowMarketplaceInstalledCommit: 'インストール済みコミット',
    workflowMarketplaceDistributionDigest: '配布ダイジェスト',
    workflowMarketplaceInstalledAt: 'インストール日時',
    workflowMarketplaceInstalledPackagePath: 'インストール済みパッケージパス',
    workflowMarketplaceRepository: 'リポジトリ',
    workflowMarketplaceRef: 'Git 参照',
    workflowMarketplaceDefaultRef: '既定のブランチ',
    workflowMarketplaceCommit: 'コミット',
    workflowMarketplaceVerified: '検証済み',
    workflowMarketplaceBlockers: '互換性の阻害要因',
    workflowMarketplaceAdvisories: '参考情報',
    workflowMarketplaceCompatibility: 'ワークフロー互換性',
    workflowMarketplaceWorkflowCount: count => `ワークフロー ${count} 件`,
    workflowMarketplaceCommands: 'コマンド',
    workflowMarketplaceScripts: 'スクリプト',
    workflowMarketplaceMcpResources: 'MCP リソース',
    workflowMarketplaceOtherResources: 'その他の共有リソース',
    workflowMarketplaceRequirements: '外部要件',
    workflowMarketplaceProviders: 'プロバイダー',
    workflowMarketplaceRuntimes: 'ランタイム',
    workflowMarketplaceSecrets: 'シークレット',
    workflowMarketplaceServices: 'サービス',
    workflowMarketplaceTools: 'ツール',
    workflowMarketplaceNoRequirements: '外部要件はありません。',
    workflowMarketplaceInstalledPackages: 'インストール済みマーケットプレイスパッケージ',
    workflowMarketplaceSourceUnavailable: 'ソースを利用できません',
    workflowMarketplaceManageSources: 'ソースを管理',
    workflowMarketplaceRefresh: '更新',
    workflowMarketplaceRefreshAll: 'すべて更新',
    workflowMarketplaceSourcesTitle: 'ワークフローソース',
    workflowMarketplaceSourcesDescription:
      '認証情報を含まない Git リポジトリを設定します。認証は Git 認証ヘルパーや SSH 設定で管理してください。',
    workflowMarketplaceAddSource: 'ソースを追加',
    workflowMarketplaceEditSource: source => `${source} を編集`,
    workflowMarketplaceRemoveSource: source => `${source} を削除`,
    workflowMarketplaceRemoveSourceAction: 'ソースを削除',
    workflowMarketplaceRemovingSource: 'ソースを削除中…',
    workflowMarketplaceEnableSource: source => `${source} を有効化`,
    workflowMarketplaceDisableSource: source => `${source} を無効化`,
    workflowMarketplaceEnableAction: '有効化',
    workflowMarketplaceDisableAction: '無効化',
    workflowMarketplaceRefreshSource: source => `${source} を更新`,
    workflowMarketplaceSourceArticle: source => `ソース ${source}`,
    workflowMarketplaceSourceName: 'ソース名',
    workflowMarketplaceRepositoryUrl: 'リポジトリ URL',
    workflowMarketplaceGitRef: 'Git 参照（任意）',
    workflowMarketplaceSaveSource: 'ソースを保存',
    workflowMarketplaceEnabled: '有効',
    workflowMarketplaceDisabled: '無効',
    workflowMarketplaceDefaultBranch: '既定のブランチ',
    workflowMarketplaceLastVerified: timestamp => `最終検証 ${timestamp}`,
    workflowMarketplaceLastAttempted: timestamp => `最終試行 ${timestamp}`,
    workflowMarketplaceNeverVerified: '未検証',
    workflowMarketplacePackageCount: count => `検証済みパッケージ ${count} 件`,
    workflowMarketplaceFresh: '最新',
    workflowMarketplaceAuthenticationRequired: '認証が必要です',
    workflowMarketplaceCancelled: 'キャンセル済み',
    workflowMarketplaceIncompatible: '非互換',
    workflowMarketplaceMalformed: '形式が不正',
    workflowMarketplaceUnavailable: '利用不可',
    workflowMarketplaceNeverRefreshed: '未更新',
    workflowMarketplaceRefreshStatusUnavailable: '更新状態を取得できません',
    workflowMarketplaceOperationEvicted:
      '更新状態の保持期限が切れました。ソース情報を再確認済みです。必要に応じて再試行してください。',
    workflowMarketplaceRefreshResultsLabel: 'ワークフローソースの更新結果',
    workflowMarketplaceRefreshResult: (source, state) => `ソース ${source}: ${state}`,
    workflowMarketplaceAuthGuidance:
      'Git 認証ヘルパー、SSH エージェントと設定、gh auth、または対応する環境認証情報を設定して再試行してください。',
    workflowMarketplaceSafeError: 'ソースの操作を完了できませんでした。設定を確認して再試行してください。',
    workflowMarketplaceRemoveTitle: source => `${source} を削除しますか？`,
    workflowMarketplaceRemoveDescription:
      'インストール済みパッケージは残ります。ソースを削除すると今後の更新を検出できなくなる場合があります。',
    workflowMarketplaceSourceRemoved: 'ソースを削除しました',
    workflowMarketplaceUnsupportedSources: 'ソースを管理・更新するには Hermes を更新してください。',
    workflowMarketplaceReviewInstallation: 'インストールを確認',
    workflowMarketplaceReviewInstallationDescription:
      'インストール前に検証済みの正確な内容、要件、実行リスクを確認してください。',
    workflowMarketplaceReviewUpdate: '更新を確認',
    workflowMarketplaceReviewUpdateDescription: '更新前にインストール済みパッケージと検証済み候補を比較してください。',
    workflowMarketplaceReviewRemoval: '削除を確認',
    workflowMarketplaceReviewRemovalDescription:
      '続行する前に対象のインストール済みパッケージと削除範囲を確認してください。',
    workflowMarketplaceReviewTrust: '信頼を確認',
    workflowMarketplaceReviewTrustDescription:
      '信頼とインストールは別の操作です。信頼を許可する前にインストール済みの内容と各ワークフローのリスクを確認してください。',
    workflowMarketplacePreparingInstallation: 'インストール確認を準備中',
    workflowMarketplacePreparingUpdate: '更新確認を準備中',
    workflowMarketplaceCheckingUpdates: '更新を確認中',
    workflowMarketplacePreparingRemoval: '削除確認を準備中',
    workflowMarketplacePreparingTrust: '信頼確認を準備中',
    workflowMarketplaceOperationProgress: (phase, progress) => `進行状況 ${phase} ${progress}%`,
    workflowMarketplaceCancelOperation: '操作をキャンセル',
    workflowMarketplaceConfirmInstall: 'インストールを確定',
    workflowMarketplaceConfirmUpdate: '更新を確定',
    workflowMarketplaceConfirmRemoval: 'パッケージを削除',
    workflowMarketplaceGrantTrust: '信頼を許可',
    workflowMarketplacePrepareAgain: '再準備',
    workflowMarketplaceRetryStatus: '状態の取得を再試行',
    workflowMarketplaceReviewDigest: '確認内容のダイジェスト',
    workflowMarketplaceCandidateVersion: '候補バージョン',
    workflowMarketplaceCandidateCommit: '候補コミット',
    workflowMarketplaceCandidateDigest: '候補ダイジェスト',
    workflowMarketplacePreviousVersion: '以前のバージョン',
    workflowMarketplacePreviousCommit: '以前のコミット',
    workflowMarketplacePreviousDigest: '以前のダイジェスト',
    workflowMarketplaceChangedFiles: '変更されたファイル',
    workflowMarketplacePhaseUnknown: '不明な段階',
    workflowMarketplacePhaseQueued: '待機中',
    workflowMarketplacePhaseRunning: '実行中',
    workflowMarketplacePhaseFetching: '取得中',
    workflowMarketplacePhaseReviewing: '確認中',
    workflowMarketplacePhaseValidating: '検証中',
    workflowMarketplacePhaseCommitting: '変更を確定中',
    workflowMarketplacePhaseRecovering: '復旧中',
    workflowMarketplacePhaseCompleted: '完了',
    workflowMarketplacePhaseFailed: '失敗',
    workflowMarketplacePhaseCancelled: 'キャンセル済み',
    workflowMarketplacePhaseChecking: '更新を確認中',
    workflowMarketplaceChangeAdded: '追加',
    workflowMarketplaceChangeModified: '変更',
    workflowMarketplaceChangeRemoved: '削除',
    workflowMarketplaceChangeRenamed: '名前変更',
    workflowMarketplaceSeverityBlocker: '阻害要因',
    workflowMarketplaceSeverityAdvisory: '注意事項',
    workflowMarketplaceDiagnosticLegacyLanguage:
      'ワークフローは互換性のため従来の緩やかな Hermes 言語規則を使用します。',
    workflowMarketplaceDiagnosticLegacyIdleTimeout: '従来のアイドルタイムアウトは秒単位で解釈されます。',
    workflowMarketplaceDiagnosticMissingProvider: '必要なプロバイダーを利用できません。',
    workflowMarketplaceDiagnosticMissingRuntime: '必要なランタイムを利用できません。',
    workflowMarketplaceDiagnosticMissingSecret: '必要なシークレットを利用できません。',
    workflowMarketplaceDiagnosticMissingService: '必要なサービスを利用できません。',
    workflowMarketplaceDiagnosticMissingTool: '必要なツールを利用できません。',
    workflowMarketplaceDiagnosticUnknown:
      'このバージョンには翻訳された説明がない互換性の問題が Hermes から報告されました。',
    workflowMarketplaceDiagnosticTechnicalDetails: '技術的な詳細',
    workflowMarketplaceDiagnosticCode: '診断コード',
    workflowMarketplaceDiagnosticMessage: 'バックエンドメッセージ',
    workflowMarketplaceFileChange: (kind, path) => `変更 ${kind}: ${path}`,
    workflowMarketplaceRenamedFrom: path => `変更前の名前: ${path}`,
    workflowMarketplacePackageResources: 'パッケージリソース',
    workflowMarketplaceWorkflowRisks: 'ワークフローのリスク',
    workflowMarketplaceDefinitionPath: '定義',
    workflowMarketplaceCompanionPath: 'コンパニオン',
    workflowMarketplaceRiskDigest: 'リスクダイジェスト',
    workflowMarketplaceShellScriptNodes: 'シェル・スクリプトノード',
    workflowMarketplaceScriptResources: 'スクリプトリソース',
    workflowMarketplaceCommandNodes: 'コマンドノード',
    workflowMarketplaceCommandResources: 'コマンドリソース',
    workflowMarketplaceLocalMcp: 'ローカル MCP サーバー',
    workflowMarketplaceRemoteMcp: 'リモート MCP サーバー',
    workflowMarketplaceMcpDefinitions: 'MCP 定義',
    workflowMarketplaceMcpResourceFiles: 'MCP リソースファイル',
    workflowMarketplaceRequestedSkills: '要求されるスキル',
    workflowMarketplaceOutwardActions: '外部アクションノード',
    workflowMarketplaceApprovalNodes: '承認ノード',
    workflowMarketplaceRequiredSecrets: '必要なシークレット',
    workflowMarketplaceWorkflowChanges: 'ワークフロー構成の変更',
    workflowMarketplaceRequirementChanges: '外部要件の変更',
    workflowMarketplaceRiskChanges: 'リスク識別情報の変更',
    workflowMarketplaceCompatibilityChanges: '互換性の変更',
    workflowMarketplaceAdded: '追加',
    workflowMarketplaceRemoved: '削除',
    workflowMarketplaceNoChanges: '変更はありません。',
    workflowMarketplaceInstalledTrustRequired: 'インストール済み — 実行には信頼が必要です',
    workflowMarketplaceUpdatedTrustRequired: version => `バージョン ${version} に更新しました — 実行には信頼が必要です`,
    workflowMarketplaceReviewTrustAction: '信頼を確認',
    workflowMarketplaceInstallFailed: 'インストールに失敗しました。新たなインストールはありません。',
    workflowMarketplaceInstallCancelled: 'インストールはキャンセルされました。新たなインストールはありません。',
    workflowMarketplaceUpdateFailed: '更新に失敗しました。',
    workflowMarketplaceUpdateCancelled: '更新はキャンセルされました。',
    workflowMarketplaceVersionRemainsInstalled: version => `バージョン ${version} が引き続きインストールされています。`,
    workflowMarketplaceNothingInstalled: '新たなインストールはありません。',
    workflowMarketplaceOperationStatusLost:
      '操作状態の保持期限が切れました。パッケージ状態を更新するか再準備してください。',
    workflowMarketplaceOperationStatusUnavailable: '操作状態は一時的に取得できません。再試行してください。',
    workflowMarketplaceReviewStale: '確認内容が変更されたか期限切れです。新しい確認を準備してください。',
    workflowMarketplacePackageCurrent: version =>
      `バージョン ${version} は最新です。更新はインストールされていません。`,
    workflowMarketplaceTrustAllWorkflows: 'すべてのワークフロー',
    workflowMarketplaceTrustOneWorkflow: 'ワークフローを一つ選択',
    workflowMarketplaceSelectWorkflow: 'ワークフローを選択',
    workflowMarketplaceTrustNotGranted: '信頼は許可されていません。新しい信頼確認を準備してください。',
    workflowMarketplaceTrustGranted: '確認済みのインストール内容に信頼を許可しました。',
    workflowMarketplaceRemovalScope: 'この名前空間のパッケージ、来歴、インストール由来の信頼許可のみ削除します。',
    workflowMarketplaceRemovalPreserves:
      'ソース設定、他のパッケージ、単独のワークフロー、独立した許可や手動の許可は残ります。',
    workflowMarketplacePackageRemoved: 'パッケージを削除しました。',
    workflowMarketplaceRemovalFailed: '削除に失敗しました。',
    workflowMarketplaceRemovalCancelled: '削除はキャンセルされました。',
    workflowMarketplaceInstallPackage: 'パッケージをインストール',
    workflowMarketplaceUpdatePackage: 'パッケージを更新',
    workflowMarketplaceCheckUpdates: '更新を確認',
    workflowMarketplaceRemovePackage: 'パッケージを削除',
    workflowMarketplaceInstalledPackageLabel: identifier => `インストール済みパッケージ ${identifier}`,
    workflowMarketplaceLifecycleUnavailable: 'インストール済みパッケージを管理するには Hermes を更新してください。',
    workflows: 'ワークフロー',
    workflowViews: 'ワークフロー表示',
    workflowCatalog: 'ワークフローカタログ',
    workflowCatalogLoading: 'ワークフローカタログを読み込み中',
    workflowCatalogErrorTitle: 'ワークフローを読み込めませんでした',
    workflowCatalogErrorDescription: 'ワークフローカタログは一時的に利用できません。',
    workflowCatalogRetry: '再試行',
    workflowCatalogEmptyTitle: 'インストール済みのワークフローはありません',
    workflowCatalogEmptyDescription: 'ワークフローパッケージをインストールすると、ここに表示されます。',
    workflowCatalogDocs: 'ワークフローのドキュメント',
    workflowCatalogPartialLabel: 'ワークフローカタログの一部',
    workflowCatalogPartialDescription: 'ワークフローカタログの一部のみを読み込めました。',
    workflowCatalogCapacityError: 'カタログの容量を超えました',
    workflowCatalogInvalidDefinition: '無効なワークフロー定義',
    workflowCatalogFilter: 'ワークフローを絞り込み',
    workflowCatalogGoToPage: page => `ワークフローの${page}ページへ移動`,
    workflowCatalogNoMatchTitle: 'フィルターに一致するワークフローはありません',
    workflowCatalogRange: (start, end, total) => `${start}～${end} / ${total}件のワークフロー`,
    workflowCatalogRowsPerPage: '1ページあたりの行数',
    workflowColumnName: '名前',
    workflowColumnVersion: 'バージョン',
    workflowColumnDescription: '説明',
    workflowColumnTrust: '信頼',
    workflowColumnInputs: '入力',
    workflowColumnSource: 'ソース',
    ...
    workflowDependencies: 'ワークフローの依存関係',
    workflowDependencySources: '依存関係のソース',
    workflowDependencyPrecedence: '優先順位',
    workflowDependencyPackages: '依存パッケージ',
    workflowExpandedNodes: '展開されたノード',
    workflowExpandedEdges: '展開されたエッジ',
    workflowIncludeDepth: 'インクルードの深さ',
    workflowCompositeDigest: '複合ダイジェスト',
    workflowIgnoredPolicies: '無視された子ポリシー',
    workflowIgnoredPolicyField: field => `無視: ${field}`,
    ...
    workflowViewDiagram: 'ダイアグラム',
    workflowViewDefinition: '定義',
    workflowViewLoading: 'ワークフローの詳細を読み込み中',
    workflowViewErrorTitle: 'ワークフローの詳細を読み込めません',
    workflowViewErrorDescription: 'ワークフローの詳細を読み込めませんでした。再試行してください。',
    workflowViewNotFound: 'このワークフローはインストールされていません。',
    workflowViewDiagramTooLarge: 'ワークフローが大きすぎるためダイアグラムを省略し、概要を表示します。',
    workflowViewDiagramOmitted: 'ダイアグラムを省略し、概要を表示します。',
    workflowViewDefinitionTitle: '正規化された定義',
    workflowViewDefinitionCaption: 'ディスク上のソースではなく、秘匿化された正規化済み定義です。',
    workflowViewCopyDefinition: '定義をコピー',
    workflowViewRunLoading: 'ワークフローの実行準備の読み込みが完了するまで実行できません。',
    workflowViewRunError: 'ワークフローの実行準備を正常に読み込めるまで実行できません。',
    workflowRun: '実行',
    ...
    workflowRunPreflightLoading: 'ワークフローの実行準備を確認中',
    workflowRunPreflightErrorTitle: 'このワークフローを確認できませんでした',
    workflowRunPreflightErrorDescription: 'ワークフローの実行準備を確認できませんでした。',
    workflowRunTrust: '信頼性の判定',
    workflowRunRisk: 'リスク概要',
    workflowRunInputs: '入力',
    workflowRunInputBytes: (used, limit) => `${used} / ${limit} バイト`,
    workflowRunInputTooLarge: (input, limit) => `${input} は ${limit} バイト以内にしてください。`,
    workflowRunBundledFixture: '同梱フィクスチャ',
    workflowRunStart: 'ワークフローを開始',
    workflowRunAt: '実行日時',
    workflowRunLater: '後で実行',
    workflowRunLaterDescription: '選択したローカル日時に、このワークフローを1回だけ実行します。',
    workflowRunScheduleInvalid: '未来の日時を選択してください。',
    workflowScheduled: 'スケジュール済み',
    workflowScheduledAt: '実行予定日時',
    workflowScheduledLocal: 'ローカル時刻',
    workflowScheduledCanonical: '標準 UTC',
    workflowRunRetry: '再試行',
    ...
    workflowRunValidationError: 'ワークフローの入力が受け付けられませんでした。',
    workflowRunRequiredInput: input => `${input} は必須です。`,
    workflowRunUnsupportedCommand: workflow =>
      `このワークフローの入力はアプリでまだ対応していません。hermes workflow run ${workflow} で実行してください。`,
    ...
    workflowRunFilter: 'ワークフロー実行を絞り込み',
    ...
    workflowAttention: '対応が必要なワークフロー',
    openWorkflowRun: workflow => `${workflow} の実行を開く`,
    attentionAge: (count, unit) => `${count}${unit === 'day' ? '日' : unit === 'hour' ? '時間' : '分'}前`,
    status: '状態',
    health: '健全性',
    graphProgress: 'グラフ進捗',
    ...
    failureCause: '失敗または停止の原因',
    overview: '概要',
    attempts: '試行',
    logs: 'ログ',
    outputs: '出力',
    recovery: '復旧',
    noEvidence: '記録された証拠はありません',
    artifactOutputType: '出力タイプ',
    artifactMediaType: 'メディアタイプ',
    artifactProducer: '生成ノード',
    artifactWinningAttempt: '採用された試行',
    artifactSize: 'サイズ',
    artifactSizeBytes: size => `${size} バイト`,
    artifactSha256: 'SHA-256',
    artifactSchemaFingerprint: 'スキーマフィンガープリント',
    artifactProducedAt: '生成日時',
    artifactSession: 'セッション',
    artifactIntegrity: '整合性',
    artifactRecovery: '復旧状態',
    artifactUnavailable: '利用できません',
    artifactPreview: '成果物をプレビュー',
    artifactDownload: '成果物をダウンロード',
    artifactDownloading: '成果物をダウンロード中',
    artifactLabel: identity => `成果物: ${identity}`,
    artifactPreviewFor: identity => `${identity}をプレビュー`,
    artifactDownloadFor: identity => `${identity}をダウンロード`,
    artifactDownloadingFor: identity => `${identity}をダウンロード中`,
    artifactDownloadCancelled: 'ダウンロードをキャンセルしました。',
    artifactDownloadErrorTitle: '成果物をダウンロードできませんでした',
    artifactDownloadErrorDescription: 'ダウンロードに失敗しました。もう一度お試しください。',
    artifactPreviewRegion: '成果物のプレビュー',
    artifactPreviewLoading: '成果物のプレビューを読み込み中',
    artifactPreviewErrorTitle: '成果物のプレビューを読み込めませんでした',
    artifactPreviewErrorDescription:
      '成果物のメタデータは引き続き利用できます。再試行するか、成果物をダウンロードしてください。',
    artifactPreviewIncomplete: 'プレビューは上限に達したため不完全です。成果物をダウンロードして確認してください。',
    artifactTextPreviewTruncated:
      '上限内のプレビューを表示しています。完全な出力は成果物をダウンロードして確認してください。',
    artifactDownloadOnly: 'このメディアタイプはプレビューできません。ダウンロードは利用できます。',
    acceptResult: '結果を受け入れる',
    continueWithFeedback: 'フィードバックして続行',
    feedback: 'フィードバック',
    provideInput: '入力を提供',
    inputValue: '入力値',
    reconcile: '照合',
    reconciliationOutcome: '確認された結果',
    confirmedSucceeded: '成功を確認',
    confirmedFailed: '失敗を確認',
    safeToRetry: '再試行可能',
    approve: '承認',
    reject: '拒否',
    cancel: 'キャンセル',
