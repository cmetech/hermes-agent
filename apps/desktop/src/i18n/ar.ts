...
export const ar = defineLocale({
  ...
  settings: {
    ...
    connectorPlugins: {
      title: 'موصلات مستقلة',
      blurb: 'إعداد موصلات الخدمات الاختيارية. تنطبق التغييرات على المحادثات الجديدة.',
      count: n => `${n} قابلة للإعداد`,
      loading: 'جار تحميل الموصلات المستقلة',
      loadFailed: 'تعذر تحميل الموصلات المستقلة',
      empty: 'لا توجد موصلات مستقلة قابلة للإعداد.',
      enabled: 'مفعّل',
      disabled: 'معطّل',
      ready: 'جاهز',
      notReady: 'غير جاهز',
      required: 'مطلوب',
      secretSet: 'تم ضبط السر',
      secretNotSet: 'لم يضبط السر',
      saveField: field => `حفظ ${field}`,
      setField: field => `ضبط ${field}`,
      clearField: field => `مسح ${field}`,
      unsupportedField: field => `لا يمكن تعديل ${field} في هذا الإصدار.`,
      saveFailed: field => `فشل حفظ ${field}`,
      clearFailed: field => `فشل مسح ${field}`,
      toggleFailed: plugin => `فشل تغيير ${plugin}`,
      readinessFailed: plugin => `فشل تحديث جاهزية ${plugin}`,
      refreshReadiness: plugin => `تحديث جاهزية ${plugin}`,
      enablePlugin: plugin => `تفعيل ${plugin}`,
      disablePlugin: plugin => `تعطيل ${plugin}`,
      authenticationRequired: field => `المصادقة مطلوبة: ${field}`,
      configurationRequired: field => `الإعداد مطلوب: ${field}`,
      invalidConfiguration: field => `إعداد غير صالح: ${field}`,
      setupRequired: action => `الإعداد مطلوب: ${action}`,
      availableNextSession: 'يتاح بعد التفعيل وبدء جلسة جديدة.',
      actionFailed: action => `فشل بدء ${action}`,
      actionStatusFailed: 'فشل التحقق من حالة الإعداد',
      actionCancelFailed: 'فشل إلغاء الإعداد',
      checkActionStatus: 'التحقق من حالة الإعداد',
      cancelAction: 'إلغاء الإعداد',
      actionStatuses: {
        cancelled: 'تم إلغاء الإعداد',
        failed: 'فشل الإعداد',
        queued: 'الإعداد في قائمة الانتظار',
        running: 'الإعداد قيد التشغيل',
        succeeded: 'اكتمل الإعداد',
        timed_out: 'انتهت مهلة الإعداد'
      }
    },
    notifications: {
      title: 'الإشعارات',
  ...
  operations: {
    workflowMarketplaceRetryCheck: 'إعادة محاولة التحقق',
    workflowMarketplaceAbsent: 'الحزمة غير مثبتة.',
    workflowMarketplaceUnconfirmed: 'تعذر تأكيد الحالة. ربما اكتملت العملية.',
    workflowMarketplaceConflict: 'هناك إجراء آخر للحزمة قيد التشغيل. لم يبدأ أي تغيير. حدّث الحالة قبل إعادة المحاولة.',
    workflowMarketplaceRecoveryRequired: 'تعذر تأكيد الحالة. استرداد الحزمة مطلوب.',
    workflowMarketplaceCancelledBeforeCommit: 'أُلغيت العملية قبل تثبيت التغييرات.',
    workflowMarketplaceRemovalCompleted: 'اكتملت إزالة الحزمة.',
    workflowMarketplaceInstalledVersionResult: version => `تم تثبيت الإصدار ${version}.`,
    workflowMarketplaceUpdatedVersionResult: version => `تم التحديث إلى الإصدار ${version}.`,
    workflowMarketplaceInstallationNoTrust: 'التثبيت لا يمنح الثقة.',
    workflowMarketplaceUntrustedRunRequirement: 'الثقة مطلوبة لتشغيل مسارات سير العمل غير الموثوقة.',
    workflowMarketplaceUpdateAvailableResult: 'يوجد تحديث متاح.',
    workflowMarketplaceCheckError: 'تعذر التحقق من التحديثات.',
    workflowMarketplaceOrphaned: 'مصدر الحزمة المثبتة غير متاح.',
    workflowMarketplaceCurrentlyInstalled: version => `الإصدار المثبت حاليًا: ${version}.`,
    workflowMarketplaceRolledBack: 'تم التراجع عن التغييرات.',
    workflowMarketplaceNoPackageChanges: 'لم تُجرِ هذه المحاولة أي تغييرات على الحزمة.',
    workflowMarketplaceReviewUnavailable: 'المراجعة غير متاحة. أعد مراجعة جديدة.',
    workflowMarketplaceTrustOneGranted: name => `مُنحت الثقة لـ ${name}.`,
    workflowMarketplaceTrustAllGranted: 'مُنحت الثقة لكل مسارات سير العمل التي تمت مراجعتها.',
    workflowMarketplaceCurrentTrust: 'الثقة الحالية للحزمة',
    workflowMarketplaceUnconfirmedRefresh: 'تعذر تأكيد الحالة. حدّث حالة الحزمة قبل إعادة المحاولة.',
    workflowMarketplaceRefreshingState: 'جارٍ تحديث حالة الحزمة',
    workflowMarketplaceLastObservedRefreshing: 'آخر حالة مرصودة — جارٍ تحديث حالة الحزمة',
    workflowMarketplaceLastObservedPrefix: 'آخر حالة مرصودة: ',
    workflowMarketplaceAbsentLastObserved: 'الحزمة غير موجودة. البيانات الوصفية من آخر رصد',
    workflowMarketplaceRecoveryUnconfirmed: 'الاسترداد مطلوب. حالة الحزمة غير مؤكدة.',
    workflowMarketplaceRefreshState: 'تحديث الحالة',
    workflowMarketplaceLastObservedSearch: 'بيانات البحث الوصفية من آخر رصد',
    workflowMarketplaceRecoveryCatalog: 'الاسترداد مطلوب. الدليل من آخر رصد.',
    workflowMarketplaceBusyCatalog: 'عمليات الحزمة قيد التنفيذ. الدليل من آخر رصد.',
    workflowMarketplaceUnconfirmedCatalog: 'حالة الحزمة غير مؤكدة. الدليل من آخر رصد.',
    workflowMarketplace: 'سوق الحزم',
    workflowMarketplaceCapabilityLoading: 'جارٍ التحقق من توفر سوق سير العمل',
    workflowMarketplaceUpgradeTitle: 'حدّث Hermes لاستخدام سوق سير العمل',
    workflowMarketplaceUpgradeDescription:
      'هذا الخادم لا يدعم حزم سير العمل بعد. حدّث Hermes لتصفحها؛ تظل عروض المثبت والنشط والسجل والأرشيف متاحة.',
    workflowMarketplaceAuthTitle: 'سجّل الدخول لتصفح حزم سير العمل',
    workflowMarketplaceAuthDescription: 'يتطلب هذا الخادم المصادقة قبل قراءة سوق سير العمل.',
    workflowMarketplaceErrorTitle: 'تعذر تحميل سوق سير العمل',
    workflowMarketplaceErrorDescription: 'خادم السوق غير متاح مؤقتًا. حاول مجددًا.',
    workflowMarketplaceSearch: 'ابحث عن حزم سير العمل',
    workflowMarketplaceSource: 'المصدر',
    workflowMarketplaceAllSources: 'كل المصادر',
    workflowMarketplaceDisabledSource: source => `${source} (معطّل)`,
    workflowMarketplaceLoading: 'جارٍ تحميل حزم سير العمل',
    workflowMarketplaceCatalogErrorTitle: 'تعذر تحميل حزم سير العمل',
    workflowMarketplaceCatalogErrorDescription: 'دليل الحزم غير متاح مؤقتًا. حاول مجددًا.',
    workflowMarketplaceSourceAuthTitle: 'مصادقة المصدر مطلوبة',
    workflowMarketplaceSourceDisabledTitle: 'مصدر سير العمل هذا معطّل',
    workflowMarketplaceEmptyTitle: 'لا توجد حزم سير عمل متاحة',
    workflowMarketplaceEmptyDescription: 'أضف مصدرًا أو حدّثه لإتاحة حزم سير العمل.',
    workflowMarketplaceNoMatchTitle: 'لا توجد حزم تطابق بحثك',
    workflowMarketplaceNoMatchDescription: 'جرّب اسم حزمة أو ناشرًا أو وسمًا أو مصدرًا مختلفًا.',
    workflowMarketplaceStale: 'مصدر قديم',
    workflowMarketplaceStaleLabel: 'نتائج سوق قديمة',
    workflowMarketplaceStaleDescription:
      'بعض أدلة المصادر قديمة. تُعرض الحزم المخزنة مؤقتًا التي تم التحقق منها، لذا قد تكون النتائج جزئية.',
    workflowMarketplacePackages: 'حزم سير العمل',
    workflowMarketplacePagination: 'صفحات حزم سير العمل',
    workflowMarketplacePreviousPage: 'الصفحة السابقة',
    workflowMarketplaceNextPage: 'الصفحة التالية',
    workflowMarketplacePage: page => `الصفحة ${page}`,
    workflowMarketplaceSelectTitle: 'اختر حزمة سير عمل',
    workflowMarketplaceSelectDescription: 'اختر حزمة لفحص محتوياتها ومتطلباتها التي تم التحقق منها.',
    workflowMarketplaceBack: 'العودة إلى الحزم',
    workflowMarketplaceDetailLoading: 'جارٍ تحميل تفاصيل حزمة سير العمل',
    workflowMarketplaceDetailErrorTitle: 'تعذر فحص هذه الحزمة',
    workflowMarketplaceDetailErrorDescription: 'تعذر تحميل تفاصيل حزمة حديثة تم التحقق منها. حاول مجددًا.',
    workflowMarketplaceDetailLabel: name => `تفاصيل حزمة ${name}`,
    workflowMarketplaceCurrent: 'حالي',
    workflowMarketplaceInstalled: 'مثبّت',
    workflowMarketplaceInstalledVersion: version => `مثبّت بالإصدار ${version}`,
    workflowMarketplaceInstalledStatusLoading: 'جارٍ تحميل حالة الحزمة المثبتة',
    workflowMarketplaceInstalledStatusUnavailableTitle: 'حالة الحزمة المثبتة غير متاحة',
    workflowMarketplaceInstalledStatusUnsupportedDescription:
      'هذا الخادم لا يعرض حالة الحزم المثبتة. قد لا تتضمن نتائج التصفح شارات التثبيت.',
    workflowMarketplaceInstalledStatusAuthTitle: 'سجّل الدخول لمقارنة الحزم المثبتة',
    workflowMarketplaceInstalledStatusAuthDescription: 'المصادقة مطلوبة لمقارنة حزم السوق المثبتة.',
    workflowMarketplaceInstalledStatusErrorDescription:
      'تعذر تحميل حالة الحزم المثبتة. قد لا تظهر شارات التثبيت في نتائج التصفح.',
    workflowMarketplaceInstalledProvenanceLoading: 'جارٍ تحميل سجل منشأ الحزمة المثبتة',
    workflowMarketplaceInstalledProvenanceUnavailableTitle: 'سجل منشأ الحزمة المثبتة غير متاح',
    workflowMarketplaceInstalledProvenanceUnsupportedDescription:
      'هذا الخادم لا يعرض سجل منشأ حزم السوق. تظل ملفات سير العمل المستقلة متاحة.',
    workflowMarketplaceInstalledProvenanceAuthTitle: 'سجّل الدخول لتحميل سجل منشأ الحزم المثبتة',
    workflowMarketplaceInstalledProvenanceAuthDescription: 'المصادقة مطلوبة لتحميل سجل منشأ حزم السوق المثبتة.',
    workflowMarketplaceInstalledProvenanceErrorTitle: 'تعذر تحميل سجل منشأ الحزمة المثبتة',
    workflowMarketplaceInstalledProvenanceErrorDescription:
      'سجل منشأ حزم السوق المثبتة غير متاح مؤقتًا. تظل ملفات سير العمل المستقلة متاحة.',
    workflowMarketplaceUpdateAvailable: 'تحديث متاح',
    workflowMarketplacePublisher: 'الناشر',
    workflowMarketplaceLicense: 'الترخيص',
    workflowMarketplaceCandidateIdentity: 'هوية الحزمة المرشحة',
    workflowMarketplacePackageDigest: 'بصمة الحزمة',
    workflowMarketplacePackagePath: 'مسار الحزمة',
    workflowMarketplaceInstalledProvenance: 'سجل منشأ الحزمة المثبتة',
    workflowMarketplaceInstalledIdentity: 'هوية التثبيت',
    workflowMarketplaceInstalledVersionLabel: 'الإصدار المثبت',
    workflowMarketplaceInstalledSource: 'مصدر التثبيت',
    workflowMarketplaceInstalledRepository: 'مستودع التثبيت',
    workflowMarketplaceInstalledRef: 'مرجع Git المثبت',
    workflowMarketplaceInstalledCommit: 'تثبيت Git المثبت',
    workflowMarketplaceDistributionDigest: 'بصمة التوزيعة',
    workflowMarketplaceInstalledAt: 'وقت التثبيت',
    workflowMarketplaceInstalledPackagePath: 'مسار الحزمة المثبتة',
    workflowMarketplaceRepository: 'المستودع',
    workflowMarketplaceRef: 'مرجع Git',
    workflowMarketplaceDefaultRef: 'الفرع الافتراضي',
    workflowMarketplaceCommit: 'تثبيت Git',
    workflowMarketplaceVerified: 'تم التحقق',
    workflowMarketplaceBlockers: 'عوائق التوافق',
    workflowMarketplaceAdvisories: 'إرشادات',
    workflowMarketplaceCompatibility: 'توافق سير العمل',
    workflowMarketplaceWorkflowCount: count => `عدد مسارات سير العمل: ${count}`,
    workflowMarketplaceCommands: 'الأوامر',
    workflowMarketplaceScripts: 'البرامج النصية',
    workflowMarketplaceMcpResources: 'موارد MCP',
    workflowMarketplaceOtherResources: 'موارد مشتركة أخرى',
    workflowMarketplaceRequirements: 'المتطلبات الخارجية',
    workflowMarketplaceProviders: 'المزوّدون',
    workflowMarketplaceRuntimes: 'بيئات التشغيل',
    workflowMarketplaceSecrets: 'الأسرار',
    workflowMarketplaceServices: 'الخدمات',
    workflowMarketplaceTools: 'الأدوات',
    workflowMarketplaceNoRequirements: 'لا توجد متطلبات خارجية.',
    workflowMarketplaceInstalledPackages: 'حزم السوق المثبتة',
    workflowMarketplaceSourceUnavailable: 'المصدر غير متاح',
    workflowMarketplaceManageSources: 'إدارة المصادر',
    workflowMarketplaceRefresh: 'تحديث',
    workflowMarketplaceRefreshAll: 'تحديث الكل',
    workflowMarketplaceSourcesTitle: 'مصادر سير العمل',
    workflowMarketplaceSourcesDescription:
      'اضبط هويات مستودعات Git دون بيانات اعتماد. تبقى المصادقة في مساعد بيانات اعتماد Git أو إعدادات SSH.',
    workflowMarketplaceAddSource: 'إضافة مصدر',
    workflowMarketplaceEditSource: source => `تعديل ${source}`,
    workflowMarketplaceRemoveSource: source => `إزالة ${source}`,
    workflowMarketplaceRemoveSourceAction: 'إزالة المصدر',
    workflowMarketplaceRemovingSource: 'جارٍ إزالة المصدر…',
    workflowMarketplaceEnableSource: source => `تفعيل ${source}`,
    workflowMarketplaceDisableSource: source => `تعطيل ${source}`,
    workflowMarketplaceEnableAction: 'تفعيل',
    workflowMarketplaceDisableAction: 'تعطيل',
    workflowMarketplaceRefreshSource: source => `تحديث ${source}`,
    workflowMarketplaceSourceArticle: source => `المصدر ${source}`,
    workflowMarketplaceSourceName: 'اسم المصدر',
    workflowMarketplaceRepositoryUrl: 'عنوان المستودع',
    workflowMarketplaceGitRef: 'مرجع Git (اختياري)',
    workflowMarketplaceSaveSource: 'حفظ المصدر',
    workflowMarketplaceEnabled: 'مفعّل',
    workflowMarketplaceDisabled: 'معطّل',
    workflowMarketplaceDefaultBranch: 'الفرع الافتراضي',
    workflowMarketplaceLastVerified: timestamp => `آخر تحقق ${timestamp}`,
    workflowMarketplaceLastAttempted: timestamp => `آخر محاولة ${timestamp}`,
    workflowMarketplaceNeverVerified: 'لم يتم التحقق بعد',
    workflowMarketplacePackageCount: count => `عدد الحزم المتحقق منها: ${count}`,
    workflowMarketplaceFresh: 'حديث',
    workflowMarketplaceAuthenticationRequired: 'المصادقة مطلوبة',
    workflowMarketplaceCancelled: 'ملغى',
    workflowMarketplaceIncompatible: 'غير متوافق',
    workflowMarketplaceMalformed: 'غير صالح البنية',
    workflowMarketplaceUnavailable: 'غير متاح',
    workflowMarketplaceNeverRefreshed: 'لم يُحدّث بعد',
    workflowMarketplaceRefreshStatusUnavailable: 'حالة التحديث غير متاحة',
    workflowMarketplaceOperationEvicted:
      'انتهت صلاحية حالة التحديث. تمت مطابقة بيانات المصدر؛ أعد المحاولة عند الحاجة.',
    workflowMarketplaceRefreshResultsLabel: 'نتائج تحديث مصادر سير العمل',
    workflowMarketplaceRefreshResult: (source, state) => `المصدر ${source}: ${state}`,
    workflowMarketplaceAuthGuidance:
      'استخدم مساعد بيانات اعتماد Git أو وكيل وإعدادات SSH أو gh auth أو بيانات البيئة المدعومة، ثم أعد المحاولة.',
    workflowMarketplaceSafeError: 'تعذر إكمال إجراء المصدر. تحقق من إعداداته وحاول مجددًا.',
    workflowMarketplaceRemoveTitle: source => `إزالة ${source}؟`,
    workflowMarketplaceRemoveDescription:
      'تظل الحزم المثبتة في مكانها. قد تؤدي إزالة المصدر إلى تعذر اكتشاف تحديثاتها.',
    workflowMarketplaceSourceRemoved: 'تمت إزالة المصدر',
    workflowMarketplaceUnsupportedSources: 'حدّث Hermes لإدارة مصادر سير العمل وتحديثها.',
    workflowMarketplaceReviewInstallation: 'مراجعة التثبيت',
    workflowMarketplaceReviewInstallationDescription:
      'راجع بايتات الحزمة المتحقق منها والمتطلبات ومخاطر التنفيذ قبل التثبيت.',
    workflowMarketplaceReviewUpdate: 'مراجعة التحديث',
    workflowMarketplaceReviewUpdateDescription: 'قارن الحزمة المثبتة بالمرشح المتحقق منه بدقة قبل التحديث.',
    workflowMarketplaceReviewRemoval: 'مراجعة الإزالة',
    workflowMarketplaceReviewRemovalDescription: 'راجع الحزمة المثبتة المحددة ونطاق الإزالة قبل المتابعة.',
    workflowMarketplaceReviewTrust: 'مراجعة الثقة',
    workflowMarketplaceReviewTrustDescription:
      'الثقة منفصلة عن التثبيت. راجع البايتات المثبتة ومخاطر سير العمل الدقيقة قبل منحها.',
    workflowMarketplacePreparingInstallation: 'جارٍ إعداد مراجعة التثبيت',
    workflowMarketplacePreparingUpdate: 'جارٍ إعداد مراجعة التحديث',
    workflowMarketplaceCheckingUpdates: 'جارٍ البحث عن تحديثات',
    workflowMarketplacePreparingRemoval: 'جارٍ إعداد مراجعة الإزالة',
    workflowMarketplacePreparingTrust: 'جارٍ إعداد مراجعة الثقة',
    workflowMarketplaceOperationProgress: (phase, progress) => `المرحلة ${phase} — ${progress}%`,
    workflowMarketplaceCancelOperation: 'إلغاء العملية',
    workflowMarketplaceConfirmInstall: 'تأكيد التثبيت',
    workflowMarketplaceConfirmUpdate: 'تأكيد التحديث',
    workflowMarketplaceConfirmRemoval: 'إزالة الحزمة',
    workflowMarketplaceGrantTrust: 'منح الثقة',
    workflowMarketplacePrepareAgain: 'الإعداد مجددًا',
    workflowMarketplaceRetryStatus: 'إعادة محاولة جلب الحالة',
    workflowMarketplaceReviewDigest: 'بصمة المراجعة',
    workflowMarketplaceCandidateVersion: 'الإصدار المرشح',
    workflowMarketplaceCandidateCommit: 'تثبيت Git المرشح',
    workflowMarketplaceCandidateDigest: 'بصمة المرشح',
    workflowMarketplacePreviousVersion: 'الإصدار السابق',
    workflowMarketplacePreviousCommit: 'تثبيت Git السابق',
    workflowMarketplacePreviousDigest: 'البصمة السابقة',
    workflowMarketplaceChangedFiles: 'الملفات المتغيرة',
    workflowMarketplacePhaseUnknown: 'مرحلة غير معروفة',
    workflowMarketplacePhaseQueued: 'قيد الانتظار',
    workflowMarketplacePhaseRunning: 'قيد التنفيذ',
    workflowMarketplacePhaseFetching: 'جارٍ الجلب',
    workflowMarketplacePhaseReviewing: 'جارٍ المراجعة',
    workflowMarketplacePhaseValidating: 'جارٍ التحقق',
    workflowMarketplacePhaseCommitting: 'جارٍ تثبيت التغييرات',
    workflowMarketplacePhaseRecovering: 'جارٍ الاسترداد',
    workflowMarketplacePhaseCompleted: 'مكتمل',
    workflowMarketplacePhaseFailed: 'فشل',
    workflowMarketplacePhaseCancelled: 'أُلغي',
    workflowMarketplacePhaseChecking: 'جارٍ البحث عن تحديثات',
    workflowMarketplaceChangeAdded: 'مضاف',
    workflowMarketplaceChangeModified: 'معدّل',
    workflowMarketplaceChangeRemoved: 'محذوف',
    workflowMarketplaceChangeRenamed: 'أُعيدت تسميته',
    workflowMarketplaceSeverityBlocker: 'مانع',
    workflowMarketplaceSeverityAdvisory: 'تنبيه',
    workflowMarketplaceDiagnosticLegacyLanguage: 'يستخدم سير العمل قواعد لغة Hermes القديمة المتساهلة.',
    workflowMarketplaceDiagnosticLegacyIdleTimeout: 'يُفسَّر حد الخمول القديم بالثواني.',
    workflowMarketplaceDiagnosticMissingProvider: 'مزوّد مطلوب غير متاح.',
    workflowMarketplaceDiagnosticMissingRuntime: 'بيئة تشغيل مطلوبة غير متاحة.',
    workflowMarketplaceDiagnosticMissingSecret: 'سر مطلوب غير متاح.',
    workflowMarketplaceDiagnosticMissingService: 'خدمة مطلوبة غير متاحة.',
    workflowMarketplaceDiagnosticMissingTool: 'أداة مطلوبة غير متاحة.',
    workflowMarketplaceDiagnosticUnknown: 'أبلغ Hermes عن مشكلة توافق لا تحتوي هذه النسخة على وصف مترجم لها.',
    workflowMarketplaceDiagnosticTechnicalDetails: 'التفاصيل الفنية',
    workflowMarketplaceDiagnosticCode: 'رمز التشخيص',
    workflowMarketplaceDiagnosticMessage: 'رسالة الخادم',
    workflowMarketplaceFileChange: (kind, path) => `التغيير ${kind}: ${path}`,
    workflowMarketplaceRenamedFrom: path => `أعيدت التسمية من ${path}`,
    workflowMarketplacePackageResources: 'موارد الحزمة',
    workflowMarketplaceWorkflowRisks: 'مخاطر سير العمل',
    workflowMarketplaceDefinitionPath: 'التعريف',
    workflowMarketplaceCompanionPath: 'الملف المرافق',
    workflowMarketplaceRiskDigest: 'بصمة المخاطر',
    workflowMarketplaceShellScriptNodes: 'عقد الصدفة أو البرامج النصية',
    workflowMarketplaceScriptResources: 'موارد البرامج النصية',
    workflowMarketplaceCommandNodes: 'عقد الأوامر',
    workflowMarketplaceCommandResources: 'موارد الأوامر',
    workflowMarketplaceLocalMcp: 'خوادم MCP المحلية',
    workflowMarketplaceRemoteMcp: 'خوادم MCP البعيدة',
    workflowMarketplaceMcpDefinitions: 'تعريفات MCP',
    workflowMarketplaceMcpResourceFiles: 'ملفات موارد MCP',
    workflowMarketplaceRequestedSkills: 'المهارات المطلوبة',
    workflowMarketplaceOutwardActions: 'عقد الإجراءات الخارجية',
    workflowMarketplaceApprovalNodes: 'عقد الموافقة',
    workflowMarketplaceRequiredSecrets: 'الأسرار المطلوبة',
    workflowMarketplaceWorkflowChanges: 'تغييرات عضوية سير العمل',
    workflowMarketplaceRequirementChanges: 'تغييرات المتطلبات الخارجية',
    workflowMarketplaceRiskChanges: 'تغييرات هوية المخاطر',
    workflowMarketplaceCompatibilityChanges: 'تغييرات التوافق',
    workflowMarketplaceAdded: 'مضاف',
    workflowMarketplaceRemoved: 'مزال',
    workflowMarketplaceNoChanges: 'لا توجد تغييرات.',
    workflowMarketplaceInstalledTrustRequired: 'تم التثبيت — الثقة مطلوبة للتشغيل',
    workflowMarketplaceUpdatedTrustRequired: version => `تم التحديث إلى الإصدار ${version} — الثقة مطلوبة للتشغيل`,
    workflowMarketplaceReviewTrustAction: 'مراجعة الثقة',
    workflowMarketplaceInstallFailed: 'فشل التثبيت. لم يتم تثبيت شيء جديد.',
    workflowMarketplaceInstallCancelled: 'أُلغي التثبيت. لم يتم تثبيت شيء جديد.',
    workflowMarketplaceUpdateFailed: 'فشل التحديث.',
    workflowMarketplaceUpdateCancelled: 'أُلغي التحديث.',
    workflowMarketplaceVersionRemainsInstalled: version => `يظل الإصدار ${version} مثبتًا.`,
    workflowMarketplaceNothingInstalled: 'لم يتم تثبيت شيء جديد.',
    workflowMarketplaceOperationStatusLost: 'انتهت صلاحية حالة العملية. حدّث حالة الحزمة أو أعد الإعداد.',
    workflowMarketplaceOperationStatusUnavailable: 'حالة العملية غير متاحة مؤقتًا. أعد المحاولة.',
    workflowMarketplaceReviewStale: 'انتهت صلاحية المراجعة أو تغيرت. أعد مراجعة جديدة قبل المتابعة.',
    workflowMarketplacePackageCurrent: version => `الإصدار ${version} هو الحالي. لم يتم تثبيت تحديث.`,
    workflowMarketplaceTrustAllWorkflows: 'كل مسارات سير العمل',
    workflowMarketplaceTrustOneWorkflow: 'سير عمل واحد',
    workflowMarketplaceSelectWorkflow: 'اختر سير عمل',
    workflowMarketplaceTrustNotGranted: 'لم تُمنح الثقة. أعد مراجعة ثقة جديدة.',
    workflowMarketplaceTrustGranted: 'مُنحت الثقة للبايتات المثبتة التي تمت مراجعتها.',
    workflowMarketplaceRemovalScope: 'ستُزال هذه الحزمة المحددة فقط مع سجل منشئها ومنح الثقة المرتبطة بتثبيتها.',
    workflowMarketplaceRemovalPreserves:
      'تبقى إعدادات المصدر والحزم الأخرى وملفات سير العمل المستقلة والمنح المستقلة أو اليدوية.',
    workflowMarketplacePackageRemoved: 'تمت إزالة الحزمة.',
    workflowMarketplaceRemovalFailed: 'فشلت الإزالة.',
    workflowMarketplaceRemovalCancelled: 'أُلغيت الإزالة.',
    workflowMarketplaceInstallPackage: 'تثبيت الحزمة',
    workflowMarketplaceUpdatePackage: 'تحديث الحزمة',
    workflowMarketplaceCheckUpdates: 'التحقق من التحديثات',
    workflowMarketplaceRemovePackage: 'إزالة الحزمة',
    workflowMarketplaceInstalledPackageLabel: identifier => `الحزمة المثبتة ${identifier}`,
    workflowMarketplaceLifecycleUnavailable: 'حدّث Hermes لإدارة حزم سير العمل المثبتة.',
