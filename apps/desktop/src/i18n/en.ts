...
export const en: Translations = {
  ...
  settings: {
    ...
    connectorPlugins: {
      title: 'Standalone connectors',
      blurb: 'Configure optional service connectors. Changes apply to new conversations.',
      count: n => `${n} configurable`,
      loading: 'Loading standalone connectors',
      loadFailed: 'Standalone connectors failed to load',
      empty: 'No configurable standalone connectors are installed.',
      enabled: 'Enabled',
      disabled: 'Disabled',
      ready: 'Ready',
      notReady: 'Not ready',
      ...
      saveField: field => `Save ${field}`,
      setField: field => `Set ${field}`,
      clearField: field => `Clear ${field}`,
      unsupportedField: field => `${field} cannot be edited in this version.`,
      saveFailed: field => `Failed to save ${field}`,
      clearFailed: field => `Failed to clear ${field}`,
      toggleFailed: plugin => `Failed to change ${plugin}`,
      readinessFailed: plugin => `Failed to refresh ${plugin} readiness`,
      refreshReadiness: plugin => `Refresh readiness for ${plugin}`,
      enablePlugin: plugin => `Enable ${plugin}`,
      disablePlugin: plugin => `Disable ${plugin}`,
      authenticationRequired: field => `Authentication required: ${field}`,
      configurationRequired: field => `Configuration required: ${field}`,
      invalidConfiguration: field => `Invalid configuration: ${field}`,
      setupRequired: action => `Setup required: ${action}`,
      availableNextSession: 'Available after enabling and starting a new session.',
      actionFailed: action => `Failed to start ${action}`,
      actionStatusFailed: 'Failed to check setup status',
      actionCancelFailed: 'Failed to cancel setup',
      checkActionStatus: 'Check setup status',
  ...
  operations: {
    workflowMarketplaceRetryCheck: 'Retry check',
    workflowMarketplaceAbsent: 'Package is absent.',
    workflowMarketplaceUnconfirmed: 'State could not be confirmed. The operation may have completed.',
    workflowMarketplaceConflict:
      'Another package action is already running. No changes were started. Refresh state before trying again.',
    workflowMarketplaceRecoveryRequired: 'State could not be confirmed. Package recovery is required.',
    workflowMarketplaceCancelledBeforeCommit: 'Cancelled before changes were committed.',
    workflowMarketplaceRemovalCompleted: 'Package removal completed.',
    workflowMarketplaceInstalledVersionResult: version => `Installed version ${version}.`,
    workflowMarketplaceUpdatedVersionResult: version => `Updated to version ${version}.`,
    workflowMarketplaceInstallationNoTrust: 'Installation does not grant trust.',
    workflowMarketplaceUntrustedRunRequirement: 'Trust required to run untrusted workflows.',
    workflowMarketplaceUpdateAvailableResult: 'An update is available.',
    workflowMarketplaceCheckError: 'Could not check for updates.',
    workflowMarketplaceOrphaned: "The installed package's source is unavailable.",
    workflowMarketplaceCurrentlyInstalled: version => `Currently installed: ${version}.`,
    workflowMarketplaceRolledBack: 'Changes were rolled back.',
    workflowMarketplaceNoPackageChanges: 'This attempt made no package changes.',
    workflowMarketplaceReviewUnavailable: 'Review is unavailable. Prepare a fresh review.',
    workflowMarketplaceTrustOneGranted: name => `Trust granted for ${name}.`,
    workflowMarketplaceTrustAllGranted: 'Trust granted for all reviewed workflows.',
    workflowMarketplaceCurrentTrust: 'Current package trust',
    workflowMarketplaceUnconfirmedRefresh: 'State could not be confirmed. Refresh package state before trying again.',
    workflowMarketplaceRefreshingState: 'Refreshing package state',
    workflowMarketplaceLastObservedRefreshing: 'Last observed — Refreshing package state',
    workflowMarketplaceLastObservedPrefix: 'Last observed: ',
    workflowMarketplaceAbsentLastObserved: 'Package is absent. Last observed metadata',
    workflowMarketplaceRecoveryUnconfirmed: 'Recovery required. Package state is unconfirmed.',
    workflowMarketplaceRefreshState: 'Refresh state',
    workflowMarketplaceLastObservedSearch: 'Last observed search metadata',
    workflowMarketplaceRecoveryCatalog: 'Recovery required. Last observed catalog.',
    workflowMarketplaceBusyCatalog: 'Package work in progress. Last observed catalog.',
    workflowMarketplaceUnconfirmedCatalog: 'Package state is unconfirmed. Last observed catalog.',
    workflows: 'Workflows',
    workflowViews: 'Workflow views',
    workflowInstalled: 'Installed',
    workflowMarketplace: 'Marketplace',
    workflowMarketplaceCapabilityLoading: 'Checking workflow marketplace availability',
    workflowMarketplaceUpgradeTitle: 'Upgrade Hermes to use Workflow Marketplace',
    workflowMarketplaceUpgradeDescription:
      'This backend does not support workflow packages yet. Upgrade Hermes to browse packages; Installed, Active, History, and Archive remain available.',
    workflowMarketplaceAuthTitle: 'Sign in to browse workflow packages',
    workflowMarketplaceAuthDescription:
      'This backend requires authentication before its workflow marketplace can be read.',
    workflowMarketplaceErrorTitle: 'Could not load Workflow Marketplace',
    workflowMarketplaceErrorDescription: 'The marketplace backend is temporarily unavailable. Try again.',
    workflowMarketplaceSearch: 'Search workflow packages',
    workflowMarketplaceSource: 'Source',
    workflowMarketplaceAllSources: 'All sources',
    workflowMarketplaceDisabledSource: source => `${source} (disabled)`,
    workflowMarketplaceLoading: 'Loading workflow packages',
    workflowMarketplaceCatalogErrorTitle: 'Could not load workflow packages',
    workflowMarketplaceCatalogErrorDescription: 'The package catalog is temporarily unavailable. Try again.',
    workflowMarketplaceSourceAuthTitle: 'Source authentication required',
    workflowMarketplaceSourceDisabledTitle: 'This workflow source is disabled',
    workflowMarketplaceEmptyTitle: 'No workflow packages available',
    workflowMarketplaceEmptyDescription: 'Add or refresh a source to make workflow packages available.',
    workflowMarketplaceNoMatchTitle: 'No packages match your search',
    workflowMarketplaceNoMatchDescription: 'Try a different package name, publisher, tag, or source.',
    workflowMarketplaceStale: 'Stale source',
    workflowMarketplaceStaleLabel: 'Stale marketplace results',
    workflowMarketplaceStaleDescription:
      'Some source catalogs are stale. Verified cached packages are shown, so results may be partial.',
    workflowMarketplacePackages: 'Workflow packages',
    workflowMarketplacePagination: 'Workflow package pages',
    workflowMarketplacePreviousPage: 'Previous page',
    workflowMarketplaceNextPage: 'Next page',
    workflowMarketplacePage: page => `Page ${page}`,
    workflowMarketplaceSelectTitle: 'Select a workflow package',
    workflowMarketplaceSelectDescription: 'Choose a package to inspect its verified contents and requirements.',
    workflowMarketplaceBack: 'Back to packages',
    workflowMarketplaceDetailLoading: 'Loading workflow package details',
    workflowMarketplaceDetailErrorTitle: 'Could not inspect this package',
    workflowMarketplaceDetailErrorDescription: 'Fresh verified package details could not be loaded. Try again.',
    workflowMarketplaceDetailLabel: name => `${name} package details`,
    workflowMarketplaceCurrent: 'Current',
    workflowMarketplaceInstalled: 'Installed',
    workflowMarketplaceInstalledVersion: version => `Installed v${version}`,
    workflowMarketplaceInstalledStatusLoading: 'Loading installed package status',
    workflowMarketplaceInstalledStatusUnavailableTitle: 'Installed package status unavailable',
    workflowMarketplaceInstalledStatusUnsupportedDescription:
      'This backend does not expose installed package status. Browse results may omit installed badges.',
    workflowMarketplaceInstalledStatusAuthTitle: 'Sign in to compare installed packages',
    workflowMarketplaceInstalledStatusAuthDescription:
      'Authentication is required to compare installed marketplace packages.',
    workflowMarketplaceInstalledStatusErrorDescription:
      'Installed package status could not be loaded. Browse results may omit installed badges.',
    workflowMarketplaceInstalledProvenanceLoading: 'Loading installed package provenance',
    workflowMarketplaceInstalledProvenanceUnavailableTitle: 'Installed package provenance unavailable',
    workflowMarketplaceInstalledProvenanceUnsupportedDescription:
      'This backend does not expose marketplace package provenance. Loose workflows remain available.',
    workflowMarketplaceInstalledProvenanceAuthTitle: 'Sign in to load installed package provenance',
    workflowMarketplaceInstalledProvenanceAuthDescription:
      'Authentication is required to load installed marketplace package provenance.',
    workflowMarketplaceInstalledProvenanceErrorTitle: 'Could not load installed package provenance',
    workflowMarketplaceInstalledProvenanceErrorDescription:
      'Installed marketplace package provenance is temporarily unavailable. Loose workflows remain available.',
    workflowMarketplaceUpdateAvailable: 'Update available',
    workflowMarketplacePublisher: 'Publisher',
    workflowMarketplaceLicense: 'License',
    workflowMarketplaceCandidateIdentity: 'Candidate package identity',
    workflowMarketplacePackageDigest: 'Package digest',
    workflowMarketplacePackagePath: 'Package path',
    workflowMarketplaceInstalledProvenance: 'Installed package provenance',
    workflowMarketplaceInstalledIdentity: 'Installed identity',
    workflowMarketplaceInstalledVersionLabel: 'Installed version',
    workflowMarketplaceInstalledSource: 'Installed source',
    workflowMarketplaceInstalledRepository: 'Installed repository',
    workflowMarketplaceInstalledRef: 'Installed ref',
    workflowMarketplaceInstalledCommit: 'Installed commit',
    workflowMarketplaceDistributionDigest: 'Distribution digest',
    workflowMarketplaceInstalledAt: 'Installed at',
    workflowMarketplaceInstalledPackagePath: 'Installed package path',
    workflowMarketplaceRepository: 'Repository',
    workflowMarketplaceRef: 'Ref',
    workflowMarketplaceDefaultRef: 'Default branch',
    workflowMarketplaceCommit: 'Commit',
    workflowMarketplaceVerified: 'Verified',
    workflowMarketplaceBlockers: 'Compatibility blockers',
    workflowMarketplaceAdvisories: 'Advisories',
    workflowMarketplaceCompatibility: 'Workflow compatibility',
    workflowMarketplaceWorkflowCount: count => `${count} workflow${count === 1 ? '' : 's'}`,
    workflowMarketplaceCommands: 'Commands',
    workflowMarketplaceScripts: 'Scripts',
    workflowMarketplaceMcpResources: 'MCP resources',
    workflowMarketplaceOtherResources: 'Other shared resources',
    workflowMarketplaceRequirements: 'External requirements',
    workflowMarketplaceProviders: 'Providers',
    workflowMarketplaceRuntimes: 'Runtimes',
    workflowMarketplaceSecrets: 'Secrets',
    workflowMarketplaceServices: 'Services',
    workflowMarketplaceTools: 'Tools',
    workflowMarketplaceNoRequirements: 'No external requirements.',
    workflowMarketplaceInstalledPackages: 'Installed marketplace packages',
    workflowMarketplaceSourceUnavailable: 'Source unavailable',
    workflowMarketplaceManageSources: 'Manage Sources',
    workflowMarketplaceRefresh: 'Refresh',
    workflowMarketplaceRefreshAll: 'Refresh all',
    workflowMarketplaceSourcesTitle: 'Workflow sources',
    workflowMarketplaceSourcesDescription:
      'Configure credential-free Git repository identities. Authentication stays in your Git credential helper or SSH configuration.',
    workflowMarketplaceAddSource: 'Add source',
    ...
    workflowMarketplaceRepositoryUrl: 'Repository URL',
    workflowMarketplaceGitRef: 'Git ref (optional)',
    workflowMarketplaceSaveSource: 'Save source',
    workflowMarketplaceEnabled: 'Enabled',
    workflowMarketplaceDisabled: 'Disabled',
    workflowMarketplaceDefaultBranch: 'Default branch',
    workflowMarketplaceLastVerified: timestamp => `Last verified ${timestamp}`,
    workflowMarketplaceLastAttempted: timestamp => `Last attempted ${timestamp}`,
    workflowMarketplaceNeverVerified: 'Never verified',
    ...
    workflowMarketplaceSafeError:
      'The source action could not be completed. Check the source configuration and try again.',
    ...
    workflowMarketplaceReviewInstallation: 'Review installation',
    workflowMarketplaceReviewInstallationDescription:
      'Review the exact verified package bytes, requirements, and executable risk before installing.',
    workflowMarketplaceReviewUpdate: 'Review update',
    workflowMarketplaceReviewUpdateDescription:
      'Compare the installed package with the exact verified candidate before updating.',
    workflowMarketplaceReviewRemoval: 'Review removal',
    workflowMarketplaceReviewRemovalDescription:
      'Review the exact installed package and removal scope before continuing.',
    workflowMarketplaceReviewTrust: 'Review trust',
    workflowMarketplaceReviewTrustDescription:
      'Trust is separate from installation. Review the installed bytes and exact workflow risks before granting it.',
    workflowMarketplacePreparingInstallation: 'Preparing installation review',
    workflowMarketplacePreparingUpdate: 'Preparing update review',
    workflowMarketplaceCheckingUpdates: 'Checking for updates',
    workflowMarketplacePreparingRemoval: 'Preparing removal review',
    workflowMarketplacePreparingTrust: 'Preparing trust review',
    workflowMarketplaceOperationProgress: (phase, progress) => `${phase} ${progress}%`,
    workflowMarketplaceCancelOperation: 'Cancel operation',
    workflowMarketplaceConfirmInstall: 'Confirm install',
    workflowMarketplaceConfirmUpdate: 'Confirm update',
    workflowMarketplaceConfirmRemoval: 'Remove package',
    workflowMarketplaceGrantTrust: 'Grant trust',
    workflowMarketplacePrepareAgain: 'Prepare again',
    workflowMarketplaceRetryStatus: 'Retry status',
    workflowMarketplaceReviewDigest: 'Review digest',
    workflowMarketplaceCandidateVersion: 'Candidate version',
    workflowMarketplaceCandidateCommit: 'Candidate commit',
    workflowMarketplaceCandidateDigest: 'Candidate digest',
    workflowMarketplacePreviousVersion: 'Previous version',
    workflowMarketplacePreviousCommit: 'Previous commit',
    workflowMarketplacePreviousDigest: 'Previous digest',
    workflowMarketplaceChangedFiles: 'Changed files',
    workflowMarketplacePhaseUnknown: 'Unknown phase',
    workflowMarketplacePhaseQueued: 'queued',
    workflowMarketplacePhaseRunning: 'running',
    workflowMarketplacePhaseFetching: 'fetching',
    workflowMarketplacePhaseReviewing: 'reviewing',
    workflowMarketplacePhaseValidating: 'validating',
    workflowMarketplacePhaseCommitting: 'committing',
    workflowMarketplacePhaseRecovering: 'recovering',
    workflowMarketplacePhaseCompleted: 'completed',
    workflowMarketplacePhaseFailed: 'failed',
    workflowMarketplacePhaseCancelled: 'cancelled',
    workflowMarketplacePhaseChecking: 'checking',
    workflowMarketplaceChangeAdded: 'added',
    workflowMarketplaceChangeModified: 'modified',
    workflowMarketplaceChangeRemoved: 'removed',
    workflowMarketplaceChangeRenamed: 'renamed',
    workflowMarketplaceSeverityBlocker: 'blocker',
    workflowMarketplaceSeverityAdvisory: 'advisory',
    workflowMarketplaceDiagnosticLegacyLanguage: 'The workflow uses permissive legacy Hermes language rules.',
    workflowMarketplaceDiagnosticLegacyIdleTimeout: 'The legacy idle timeout is interpreted in seconds.',
    workflowMarketplaceDiagnosticMissingProvider: 'A required provider is unavailable.',
    workflowMarketplaceDiagnosticMissingRuntime: 'A required runtime is unavailable.',
    workflowMarketplaceDiagnosticMissingSecret: 'A required secret is unavailable.',
    workflowMarketplaceDiagnosticMissingService: 'A required service is unavailable.',
    workflowMarketplaceDiagnosticMissingTool: 'A required tool is unavailable.',
    workflowMarketplaceDiagnosticUnknown:
      'Hermes reported a compatibility issue that has no translated description in this version.',
    workflowMarketplaceDiagnosticTechnicalDetails: 'Technical details',
    workflowMarketplaceDiagnosticCode: 'Diagnostic code',
    workflowMarketplaceDiagnosticMessage: 'Backend message',
    workflowMarketplaceFileChange: (kind, path) => `${kind}: ${path}`,
    workflowMarketplaceRenamedFrom: path => `Renamed from ${path}`,
    workflowMarketplacePackageResources: 'Package resources',
    workflowMarketplaceWorkflowRisks: 'Workflow risks',
    workflowMarketplaceDefinitionPath: 'Definition',
    workflowMarketplaceCompanionPath: 'Companion',
    workflowMarketplaceRiskDigest: 'Risk digest',
    workflowMarketplaceShellScriptNodes: 'Shell or script nodes',
    workflowMarketplaceScriptResources: 'Script resources',
    workflowMarketplaceCommandNodes: 'Command nodes',
    workflowMarketplaceCommandResources: 'Command resources',
    workflowMarketplaceLocalMcp: 'Local MCP servers',
    workflowMarketplaceRemoteMcp: 'Remote MCP servers',
    workflowMarketplaceMcpDefinitions: 'MCP definitions',
    workflowMarketplaceMcpResourceFiles: 'MCP resource files',
    workflowMarketplaceRequestedSkills: 'Requested skills',
    workflowMarketplaceOutwardActions: 'Outward action nodes',
    workflowMarketplaceApprovalNodes: 'Approval nodes',
    workflowMarketplaceRequiredSecrets: 'Required secrets',
    workflowMarketplaceWorkflowChanges: 'Workflow membership changes',
    workflowMarketplaceRequirementChanges: 'External requirement changes',
    workflowMarketplaceRiskChanges: 'Risk identity changes',
    workflowMarketplaceCompatibilityChanges: 'Compatibility changes',
    workflowMarketplaceAdded: 'Added',
    workflowMarketplaceRemoved: 'Removed',
    workflowMarketplaceNoChanges: 'No changes.',
    workflowMarketplaceInstalledTrustRequired: 'Installed — trust required to run',
    workflowMarketplaceUpdatedTrustRequired: version => `Updated to version ${version} — trust required to run`,
    workflowMarketplaceReviewTrustAction: 'Review trust',
    workflowMarketplaceInstallFailed: 'Installation failed. Nothing new was installed.',
    workflowMarketplaceInstallCancelled: 'Installation was cancelled. Nothing new was installed.',
    workflowMarketplaceUpdateFailed: 'Update failed.',
    workflowMarketplaceUpdateCancelled: 'Update was cancelled.',
    workflowMarketplaceVersionRemainsInstalled: version => `Version ${version} remains installed.`,
    workflowMarketplaceNothingInstalled: 'Nothing new was installed.',
    workflowMarketplaceOperationStatusLost: 'Operation status expired. Refresh package truth or prepare again.',
    workflowMarketplaceOperationStatusUnavailable: 'Operation status is temporarily unavailable. Retry.',
    workflowMarketplaceReviewStale: 'The review expired or changed. Prepare a fresh review before continuing.',
    workflowMarketplacePackageCurrent: version => `Version ${version} is current. No update was installed.`,
    workflowMarketplaceTrustAllWorkflows: 'All workflows',
    workflowMarketplaceTrustOneWorkflow: 'One workflow',
    workflowMarketplaceSelectWorkflow: 'Select workflow',
    workflowMarketplaceTrustNotGranted: 'Trust was not granted. Prepare a fresh trust review.',
    workflowMarketplaceTrustGranted: 'Trust granted for the reviewed installed bytes.',
    workflowMarketplaceRemovalScope:
      'Only this namespaced package, its provenance, and installation-origin trust grants will be removed.',
    workflowMarketplaceRemovalPreserves:
      'The source definition, other packages, loose workflows, and independent or manual grants remain.',
    workflowMarketplacePackageRemoved: 'Package removed.',
    workflowMarketplaceRemovalFailed: 'Removal failed.',
    workflowMarketplaceRemovalCancelled: 'Removal was cancelled.',
    workflowMarketplaceInstallPackage: 'Install package',
    workflowMarketplaceUpdatePackage: 'Update package',
    workflowMarketplaceCheckUpdates: 'Check for updates',
    workflowMarketplaceRemovePackage: 'Remove package',
    workflowMarketplaceInstalledPackageLabel: identifier => `${identifier} installed package`,
    workflowMarketplaceLifecycleUnavailable: 'Upgrade Hermes to manage installed workflow packages.',
    workflowCatalog: 'Workflow catalog',
    workflowCatalogLoading: 'Loading workflow catalog',
    workflowCatalogErrorTitle: 'Could not load workflows',
    workflowCatalogErrorDescription: 'The workflow catalog is temporarily unavailable.',
    workflowCatalogRetry: 'Retry',
    workflowCatalogEmptyTitle: 'No workflows installed',
    workflowCatalogEmptyDescription: 'Install a workflow package to make it available here.',
    workflowCatalogDocs: 'Workflow documentation',
    workflowCatalogPartialLabel: 'Partial workflow catalog',
    workflowCatalogPartialDescription: 'Only part of the workflow catalog could be loaded.',
    workflowCatalogCapacityError: 'The catalog capacity was exceeded',
    workflowCatalogInvalidDefinition: 'Invalid workflow definition',
    workflowCatalogFilter: 'Filter workflows',
    workflowCatalogGoToPage: page => `Go to workflow page ${page}`,
    workflowCatalogNoMatchTitle: 'No workflows match your filter',
    workflowCatalogRange: (start, end, total) => `${start}–${end} of ${total} workflows`,
    workflowCatalogRowsPerPage: 'Rows per page',
    workflowColumnName: 'Name',
    workflowColumnVersion: 'Version',
    workflowColumnDescription: 'Description',
    workflowColumnTrust: 'Trust',
    workflowColumnInputs: 'Inputs',
    workflowColumnSource: 'Source',
    ...
    workflowDependencySources: 'Dependency sources',
    workflowDependencyPrecedence: 'Precedence',
    workflowDependencyPackages: 'Dependency packages',
    workflowExpandedNodes: 'Expanded nodes',
    workflowExpandedEdges: 'Expanded edges',
    workflowIncludeDepth: 'Include depth',
    workflowCompositeDigest: 'Composite digest',
    workflowIgnoredPolicies: 'Ignored child policies',
    workflowIgnoredPolicyField: field => `Ignored: ${field}`,
    ...
    workflowSourceBundled: 'Bundled showcase',
    workflowView: 'View',
    workflowViewTitle: workflow => `View ${workflow}`,
    workflowViewDescription: 'Inspect this workflow without changing or starting it.',
    workflowViewDiagram: 'Diagram',
    workflowViewDefinition: 'Definition',
    workflowViewLoading: 'Loading workflow details',
    workflowViewErrorTitle: 'Unable to load workflow details',
    workflowViewErrorDescription: 'The workflow details could not be loaded. Try again.',
    workflowViewNotFound: 'This workflow is no longer installed.',
    workflowViewDiagramTooLarge: 'Diagram omitted because the workflow is too large — showing outline.',
    workflowViewDiagramOmitted: 'Diagram omitted — showing outline.',
    workflowViewDefinitionTitle: 'Normalized definition',
    workflowViewDefinitionCaption: 'Redacted normalized definition — not the on-disk source.',
    workflowViewCopyDefinition: 'Copy definition',
    workflowViewRunLoading: 'Run is unavailable until workflow readiness finishes loading.',
    workflowViewRunError: 'Run is unavailable until workflow readiness loads successfully.',
    workflowRun: 'Run',
    ...
    workflowRunPreflightLoading: 'Checking workflow readiness',
    workflowRunPreflightErrorTitle: 'Could not review this workflow',
    workflowRunPreflightErrorDescription: 'Workflow readiness could not be checked.',
    workflowRunTrust: 'Trust verdict',
    workflowRunRisk: 'Risk summary',
    workflowRunInputs: 'Inputs',
    workflowRunInputBytes: (used, limit) => `${used} / ${limit} bytes`,
    workflowRunInputTooLarge: (input, limit) => `${input} exceeds the ${limit}-byte limit.`,
    workflowRunBundledFixture: 'Bundled fixture',
    workflowRunStart: 'Start workflow',
    workflowRunAt: 'Run at',
    workflowRunLater: 'Run later',
    workflowRunLaterDescription: 'Schedule this workflow once at the selected local date and time.',
    workflowRunScheduleInvalid: 'Choose a future date and time.',
    workflowScheduled: 'Scheduled',
    workflowScheduledAt: 'Scheduled time',
    workflowScheduledLocal: 'Local time',
    workflowScheduledCanonical: 'Canonical UTC',
    workflowRunRetry: 'Retry',
    ...
    workflowRunProviderAuthorityUnavailable: 'Provider readiness changed. Review it before starting.',
    workflowProviderReadiness: 'Provider readiness',
    workflowProviderAuthorityDigest: 'Authority digest',
    workflowProviderCapabilityLevel: 'Capability level',
    ...
    workflowRunProfileUnavailable: 'The run started, but its profile could not be opened. Retry to locate it.',
    workflowRunValidationError: 'The workflow inputs were not accepted.',
    workflowRunRequiredInput: input => `${input} is required.`,
    workflowRunUnsupportedCommand: workflow =>
      `This workflow's inputs aren't supported in the app yet — run it with hermes workflow run ${workflow}.`,
    ...
    workflowRunFilter: 'Filter workflow runs',
    ...
    openWorkflowRun: workflow => `Open run ${workflow}`,
    attentionAge: (count, unit) => `${count} ${unit}${count === 1 ? '' : 's'} ago`,
    status: 'Status',
    health: 'Health',
    ...
    failureCause: 'Failure or stall cause',
    overview: 'Overview',
    attempts: 'Attempts',
    logs: 'Logs',
    outputs: 'Outputs',
    ...
    artifactOutputType: 'Output type',
    artifactMediaType: 'Media type',
    artifactProducer: 'Producer',
    artifactWinningAttempt: 'Winning attempt',
    artifactSize: 'Size',
    artifactSizeBytes: size => `${size} bytes`,
    artifactSha256: 'SHA-256',
    artifactSchemaFingerprint: 'Schema fingerprint',
    artifactProducedAt: 'Produced at',
    ...
    artifactDownloading: 'Downloading artifact',
    artifactLabel: identity => `Artifact: ${identity}`,
    artifactPreviewFor: identity => `Preview artifact: ${identity}`,
    artifactDownloadFor: identity => `Download artifact: ${identity}`,
    artifactDownloadingFor: identity => `Downloading artifact: ${identity}`,
    artifactDownloadCancelled: 'Download canceled.',
    artifactDownloadErrorTitle: 'Could not download artifact',
    artifactDownloadErrorDescription: 'The download failed. Try again.',
    artifactPreviewRegion: 'Artifact preview',
    artifactPreviewLoading: 'Loading artifact preview',
    artifactPreviewErrorTitle: 'Could not load artifact preview',
    artifactPreviewErrorDescription: 'The artifact metadata remains available. You can retry or download the artifact.',
    artifactPreviewIncomplete: 'The bounded preview is incomplete. Download the artifact to inspect it.',
    artifactTextPreviewTruncated: 'Showing a bounded preview. Download the artifact to inspect the complete output.',
    artifactDownloadOnly: 'Preview unavailable for this media type. Download remains available.',
    acceptResult: 'Accept result',
    continueWithFeedback: 'Continue with feedback',
    feedback: 'Feedback',
    provideInput: 'Provide input',
    inputValue: 'Input value',
    reconcile: 'Reconcile',
    reconciliationOutcome: 'Observed outcome',
    confirmedSucceeded: 'Confirmed succeeded',
