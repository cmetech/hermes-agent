...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    connectorPlugins: {
      title: '獨立連接器',
      blurb: '設定選用的服務連接器。變更將在新對話中生效。',
      count: n => `${n} 個可設定`,
      loading: '正在載入獨立連接器',
      loadFailed: '無法載入獨立連接器',
      empty: '尚未安裝可設定的獨立連接器。',
      enabled: '已啟用',
      disabled: '已停用',
      ready: '就緒',
      ...
      secretSet: '密鑰已設定',
      secretNotSet: '密鑰未設定',
      saveField: field => `儲存${field}`,
      setField: field => `設定${field}`,
      clearField: field => `清除${field}`,
      unsupportedField: field => `此版本無法編輯${field}。`,
      saveFailed: field => `儲存${field}失敗`,
      clearFailed: field => `清除${field}失敗`,
      toggleFailed: plugin => `變更${plugin}失敗`,
      readinessFailed: plugin => `重新整理${plugin}就緒狀態失敗`,
      refreshReadiness: plugin => `重新整理${plugin}的就緒狀態`,
      enablePlugin: plugin => `啟用${plugin}`,
      disablePlugin: plugin => `停用${plugin}`,
      authenticationRequired: field => `需要驗證：${field}`,
      configurationRequired: field => `需要設定：${field}`,
      invalidConfiguration: field => `設定無效：${field}`,
      setupRequired: action => `需要設定：${action}`,
      availableNextSession: '啟用並開始新工作階段後可用。',
      actionFailed: action => `啟動${action}失敗`,
      actionStatusFailed: '檢查設定狀態失敗',
      actionCancelFailed: '取消設定失敗',
      checkActionStatus: '檢查設定狀態',
      cancelAction: '取消設定',
      actionStatuses: {
        cancelled: '設定已取消',
        failed: '設定失敗',
    ...
    model: {
      ...
      automaticRouting: '自動路由',
      currentNeedsReview: '需要檢查',
      grandfatheredWarning: '此已儲存模型作為舊有設定保留，未進行變更。準備好後請選擇已驗證的模型。',
      refreshModels: '重新整理模型',
      eligibilityReasons: {
        'authentication-required': 'Gateway 需要驗證',
        'capability-response-invalid': '功能回應不相容',
        'catalog-empty': '沒有可用的具體模型',
        'gateway-unreachable': 'Gateway 無法使用',
        'gateway-upgrade-required': '需要更新 Gateway',
        unknown: '模型狀態未知',
        'automatic-not-allowed': '無法在此固定自動路由',
        'model-not-live': '已不在即時模型目錄中',
        'completion-unknown': '尚未驗證補全功能',
        'completion-unsupported': '不支援補全',
        'tools-unknown': '尚未驗證工具支援',
        'tools-unsupported': '不支援工具',
        'vision-unknown': '尚未驗證視覺支援',
        'vision-unsupported': '不支援視覺'
      },
      providerReadiness: {
        'authentication-required': '請在金鑰頁面設定 OTTO_API_KEY 以使用 Gateway 模型。',
        'capability-response-invalid': 'Gateway 傳回了不相容的功能回應。',
        'catalog-empty': 'Gateway 未傳回具體模型。請重新整理模型目錄後再試一次。',
        'gateway-unreachable': 'Gateway 無法使用。請重新整理模型目錄後再試一次。',
        'gateway-upgrade-required': '請更新 Gateway 以載入已驗證的模型功能。',
        unknown: 'Gateway 模型狀態未知。請重新整理模型目錄後再試一次。'
      },
      tasks: {
  ...
  operations: {
    workflowMarketplaceRetryCheck: '重試檢查',
    workflowMarketplaceAbsent: '未安裝此套件。',
    workflowMarketplaceUnconfirmed: '無法確認狀態。操作可能已完成。',
    workflowMarketplaceConflict: '另一個套件操作正在執行。尚未開始變更。請重新整理狀態後重試。',
    workflowMarketplaceRecoveryRequired: '無法確認狀態。需要復原套件交易。',
    workflowMarketplaceCancelledBeforeCommit: '已在提交變更前取消。',
    workflowMarketplaceRemovalCompleted: '套件移除已完成。',
    workflowMarketplaceInstalledVersionResult: version => `已安裝版本 ${version}。`,
    workflowMarketplaceUpdatedVersionResult: version => `已更新至版本 ${version}。`,
    workflowMarketplaceInstallationNoTrust: '安裝不會授予信任。',
    workflowMarketplaceUntrustedRunRequirement: '執行未受信任的工作流程需要先授予信任。',
    workflowMarketplaceUpdateAvailableResult: '有可用更新。',
    workflowMarketplaceCheckError: '無法檢查更新。',
    workflowMarketplaceOrphaned: '已安裝套件的來源無法使用。',
    workflowMarketplaceCurrentlyInstalled: version => `目前已安裝：${version}。`,
    workflowMarketplaceRolledBack: '變更已回復。',
    workflowMarketplaceNoPackageChanges: '此次嘗試未變更套件。',
    workflowMarketplaceReviewUnavailable: '審查無法使用。請重新準備審查。',
    workflowMarketplaceTrustOneGranted: name => `已為 ${name} 授予信任。`,
    workflowMarketplaceTrustAllGranted: '已為所有審查過的工作流程授予信任。',
    workflowMarketplaceCurrentTrust: '目前套件信任狀態',
    workflowMarketplaceUnconfirmedRefresh: '無法確認狀態。請重新整理套件狀態後重試。',
    workflowMarketplaceRefreshingState: '正在重新整理套件狀態',
    workflowMarketplaceLastObservedRefreshing: '上次觀察結果 — 正在重新整理套件狀態',
    workflowMarketplaceLastObservedPrefix: '上次觀察結果：',
    workflowMarketplaceAbsentLastObserved: '套件不存在。顯示上次觀察到的中繼資料',
    workflowMarketplaceRecoveryUnconfirmed: '需要復原。套件狀態尚未確認。',
    workflowMarketplaceRefreshState: '重新整理狀態',
    workflowMarketplaceLastObservedSearch: '上次觀察到的搜尋中繼資料',
    workflowMarketplaceRecoveryCatalog: '需要復原。顯示上次觀察到的目錄。',
    workflowMarketplaceBusyCatalog: '套件操作正在進行。顯示上次觀察到的目錄。',
    workflowMarketplaceUnconfirmedCatalog: '套件狀態尚未確認。顯示上次觀察到的目錄。',
    workflowMarketplace: '市集',
    workflowMarketplaceCapabilityLoading: '正在檢查工作流程市集可用性',
    workflowMarketplaceUpgradeTitle: '升級 Hermes 以使用工作流程市集',
    workflowMarketplaceUpgradeDescription:
      '此後端尚不支援工作流程套件。請升級 Hermes；已安裝、活動、歷史和封存檢視仍可使用。',
    workflowMarketplaceAuthTitle: '登入以瀏覽工作流程套件',
    workflowMarketplaceAuthDescription: '此後端要求驗證身分後才能讀取工作流程市集。',
    workflowMarketplaceErrorTitle: '無法載入工作流程市集',
    workflowMarketplaceErrorDescription: '市集後端暫時無法使用。請重試。',
    workflowMarketplaceSearch: '搜尋工作流程套件',
    workflowMarketplaceSource: '來源',
    workflowMarketplaceAllSources: '所有來源',
    workflowMarketplaceDisabledSource: source => `${source}（已停用）`,
    workflowMarketplaceLoading: '正在載入工作流程套件',
    workflowMarketplaceCatalogErrorTitle: '無法載入工作流程套件',
    workflowMarketplaceCatalogErrorDescription: '套件目錄暫時無法使用。請重試。',
    workflowMarketplaceSourceAuthTitle: '來源需要身分驗證',
    workflowMarketplaceSourceDisabledTitle: '此工作流程來源已停用',
    workflowMarketplaceEmptyTitle: '沒有可用的工作流程套件',
    workflowMarketplaceEmptyDescription: '新增或重新整理來源以取得工作流程套件。',
    workflowMarketplaceNoMatchTitle: '沒有符合搜尋條件的套件',
    workflowMarketplaceNoMatchDescription: '請嘗試其他套件名稱、發布者、標籤或來源。',
    workflowMarketplaceStale: '來源已過期',
    workflowMarketplaceStaleLabel: '已過期的市集結果',
    workflowMarketplaceStaleDescription: '部分來源目錄已過期。目前顯示已驗證的快取套件，結果可能不完整。',
    workflowMarketplacePackages: '工作流程套件',
    workflowMarketplacePagination: '工作流程套件分頁',
    workflowMarketplacePreviousPage: '上一頁',
    workflowMarketplaceNextPage: '下一頁',
    workflowMarketplacePage: page => `第 ${page} 頁`,
    workflowMarketplaceSelectTitle: '選取工作流程套件',
    workflowMarketplaceSelectDescription: '選取套件以檢查已驗證的內容與需求。',
    workflowMarketplaceBack: '返回套件清單',
    workflowMarketplaceDetailLoading: '正在載入工作流程套件詳情',
    workflowMarketplaceDetailErrorTitle: '無法檢查此套件',
    workflowMarketplaceDetailErrorDescription: '無法載入最新的已驗證套件詳情。請重試。',
    workflowMarketplaceDetailLabel: name => `${name} 套件詳情`,
    workflowMarketplaceCurrent: '目前',
    workflowMarketplaceInstalled: '已安裝',
    workflowMarketplaceInstalledVersion: version => `已安裝 v${version}`,
    workflowMarketplaceInstalledStatusLoading: '正在載入已安裝套件狀態',
    workflowMarketplaceInstalledStatusUnavailableTitle: '已安裝套件狀態無法使用',
    workflowMarketplaceInstalledStatusUnsupportedDescription:
      '此後端不提供已安裝套件狀態，瀏覽結果可能不顯示安裝標記。',
    workflowMarketplaceInstalledStatusAuthTitle: '登入以比較已安裝套件',
    workflowMarketplaceInstalledStatusAuthDescription: '比較已安裝的市集套件需要身分驗證。',
    workflowMarketplaceInstalledStatusErrorDescription: '無法載入已安裝套件狀態，瀏覽結果可能不顯示安裝標記。',
    workflowMarketplaceInstalledProvenanceLoading: '正在載入已安裝套件來源紀錄',
    workflowMarketplaceInstalledProvenanceUnavailableTitle: '已安裝套件來源紀錄無法使用',
    workflowMarketplaceInstalledProvenanceUnsupportedDescription:
      '此後端不提供市集套件來源紀錄。獨立工作流程仍可使用。',
    workflowMarketplaceInstalledProvenanceAuthTitle: '登入以載入已安裝套件來源紀錄',
    workflowMarketplaceInstalledProvenanceAuthDescription: '載入已安裝市集套件的來源紀錄需要身分驗證。',
    workflowMarketplaceInstalledProvenanceErrorTitle: '無法載入已安裝套件來源紀錄',
    workflowMarketplaceInstalledProvenanceErrorDescription:
      '已安裝市集套件來源紀錄暫時無法使用。獨立工作流程仍可使用。',
    workflowMarketplaceUpdateAvailable: '有可用更新',
    workflowMarketplacePublisher: '發布者',
    workflowMarketplaceLicense: '授權條款',
    workflowMarketplaceCandidateIdentity: '候選套件識別資訊',
    workflowMarketplacePackageDigest: '套件摘要',
    workflowMarketplacePackagePath: '套件路徑',
    workflowMarketplaceInstalledProvenance: '已安裝套件來源紀錄',
    workflowMarketplaceInstalledIdentity: '安裝識別資訊',
    workflowMarketplaceInstalledVersionLabel: '已安裝版本',
    workflowMarketplaceInstalledSource: '安裝來源',
    workflowMarketplaceInstalledRepository: '安裝儲存庫',
    workflowMarketplaceInstalledRef: '已安裝 Git 參照',
    workflowMarketplaceInstalledCommit: '已安裝提交',
    workflowMarketplaceDistributionDigest: '發行摘要',
    workflowMarketplaceInstalledAt: '安裝時間',
    workflowMarketplaceInstalledPackagePath: '已安裝套件路徑',
    workflowMarketplaceRepository: '儲存庫',
    workflowMarketplaceRef: 'Git 參照',
    workflowMarketplaceDefaultRef: '預設分支',
    workflowMarketplaceCommit: '提交',
    workflowMarketplaceVerified: '已驗證',
    workflowMarketplaceBlockers: '相容性阻礙',
    workflowMarketplaceAdvisories: '提示',
    workflowMarketplaceCompatibility: '工作流程相容性',
    workflowMarketplaceWorkflowCount: count => `${count} 個工作流程`,
    workflowMarketplaceCommands: '命令',
    workflowMarketplaceScripts: '指令碼',
    workflowMarketplaceMcpResources: 'MCP 資源',
    workflowMarketplaceOtherResources: '其他共用資源',
    workflowMarketplaceRequirements: '外部需求',
    workflowMarketplaceProviders: '供應商',
    workflowMarketplaceRuntimes: '執行環境',
    workflowMarketplaceSecrets: '密鑰',
    workflowMarketplaceServices: '服務',
    workflowMarketplaceTools: '工具',
    workflowMarketplaceNoRequirements: '沒有外部需求。',
    workflowMarketplaceInstalledPackages: '已安裝的市集套件',
    workflowMarketplaceSourceUnavailable: '來源無法使用',
    workflowMarketplaceManageSources: '管理來源',
    workflowMarketplaceRefresh: '重新整理',
    workflowMarketplaceRefreshAll: '全部重新整理',
    workflowMarketplaceSourcesTitle: '工作流程來源',
    workflowMarketplaceSourcesDescription:
      '設定不含憑證的 Git 儲存庫識別資訊。身分驗證由 Git 憑證助手或 SSH 設定管理。',
    workflowMarketplaceAddSource: '新增來源',
    workflowMarketplaceEditSource: source => `編輯 ${source}`,
    workflowMarketplaceRemoveSource: source => `移除 ${source}`,
    workflowMarketplaceRemoveSourceAction: '移除來源',
    workflowMarketplaceRemovingSource: '正在移除來源…',
    workflowMarketplaceEnableSource: source => `啟用 ${source}`,
    workflowMarketplaceDisableSource: source => `停用 ${source}`,
    workflowMarketplaceEnableAction: '啟用',
    workflowMarketplaceDisableAction: '停用',
    workflowMarketplaceRefreshSource: source => `重新整理 ${source}`,
    workflowMarketplaceSourceArticle: source => `來源 ${source}`,
    workflowMarketplaceSourceName: '來源名稱',
    workflowMarketplaceRepositoryUrl: '儲存庫 URL',
    workflowMarketplaceGitRef: 'Git 參照（選填）',
    workflowMarketplaceSaveSource: '儲存來源',
    workflowMarketplaceEnabled: '已啟用',
    workflowMarketplaceDisabled: '已停用',
    workflowMarketplaceDefaultBranch: '預設分支',
    workflowMarketplaceLastVerified: timestamp => `上次驗證 ${timestamp}`,
    workflowMarketplaceLastAttempted: timestamp => `上次嘗試 ${timestamp}`,
    workflowMarketplaceNeverVerified: '從未驗證',
    workflowMarketplacePackageCount: count => `${count} 個已驗證套件`,
    workflowMarketplaceFresh: '最新',
    workflowMarketplaceAuthenticationRequired: '需要身分驗證',
    workflowMarketplaceCancelled: '已取消',
    workflowMarketplaceIncompatible: '不相容',
    workflowMarketplaceMalformed: '格式錯誤',
    workflowMarketplaceUnavailable: '無法使用',
    workflowMarketplaceNeverRefreshed: '從未重新整理',
    workflowMarketplaceRefreshStatusUnavailable: '重新整理狀態無法使用',
    workflowMarketplaceOperationEvicted: '重新整理狀態已過期。來源資料已重新核對，請視需要重試。',
    workflowMarketplaceRefreshResultsLabel: '工作流程來源重新整理結果',
    workflowMarketplaceRefreshResult: (source, state) => `來源 ${source}：${state}`,
    workflowMarketplaceAuthGuidance: '設定 Git 憑證助手、SSH 代理或設定、gh auth 或支援的環境憑證，然後重試。',
    workflowMarketplaceSafeError: '無法完成來源操作。請檢查來源設定後重試。',
    workflowMarketplaceRemoveTitle: source => `移除 ${source}？`,
    workflowMarketplaceRemoveDescription: '已安裝的套件會保留。移除此來源可能導致無法探索後續更新。',
    workflowMarketplaceSourceRemoved: '來源已移除',
    workflowMarketplaceUnsupportedSources: '升級 Hermes 以管理和重新整理工作流程來源。',
    workflowMarketplaceReviewInstallation: '審查安裝',
    workflowMarketplaceReviewInstallationDescription: '安裝前審查經過驗證的確切套件內容、需求與執行風險。',
    workflowMarketplaceReviewUpdate: '審查更新',
    workflowMarketplaceReviewUpdateDescription: '更新前將已安裝套件與經過驗證的確切候選套件比較。',
    workflowMarketplaceReviewRemoval: '審查移除',
    workflowMarketplaceReviewRemovalDescription: '繼續前審查確切的已安裝套件與移除範圍。',
    workflowMarketplaceReviewTrust: '審查信任',
    workflowMarketplaceReviewTrustDescription: '信任與安裝是獨立操作。授予信任前請審查已安裝內容與確切的工作流程風險。',
    workflowMarketplacePreparingInstallation: '正在準備安裝審查',
    workflowMarketplacePreparingUpdate: '正在準備更新審查',
    workflowMarketplaceCheckingUpdates: '正在檢查更新',
    workflowMarketplacePreparingRemoval: '正在準備移除審查',
    workflowMarketplacePreparingTrust: '正在準備信任審查',
    workflowMarketplaceOperationProgress: (phase, progress) => `進度 ${phase} ${progress}%`,
    workflowMarketplaceCancelOperation: '取消操作',
    workflowMarketplaceConfirmInstall: '確認安裝',
    workflowMarketplaceConfirmUpdate: '確認更新',
    workflowMarketplaceConfirmRemoval: '移除套件',
    workflowMarketplaceGrantTrust: '授予信任',
    workflowMarketplacePrepareAgain: '重新準備',
    workflowMarketplaceRetryStatus: '重試狀態查詢',
    workflowMarketplaceReviewDigest: '審查摘要',
    workflowMarketplaceCandidateVersion: '候選版本',
    workflowMarketplaceCandidateCommit: '候選提交',
    workflowMarketplaceCandidateDigest: '候選摘要',
    workflowMarketplacePreviousVersion: '先前版本',
    workflowMarketplacePreviousCommit: '先前提交',
    workflowMarketplacePreviousDigest: '先前摘要',
    workflowMarketplaceChangedFiles: '已變更檔案',
    workflowMarketplacePhaseUnknown: '未知階段',
    workflowMarketplacePhaseQueued: '佇列中',
    workflowMarketplacePhaseRunning: '執行中',
    workflowMarketplacePhaseFetching: '取得中',
    workflowMarketplacePhaseReviewing: '審查中',
    workflowMarketplacePhaseValidating: '驗證中',
    workflowMarketplacePhaseCommitting: '提交變更中',
    workflowMarketplacePhaseRecovering: '復原中',
    workflowMarketplacePhaseCompleted: '已完成',
    workflowMarketplacePhaseFailed: '已失敗',
    workflowMarketplacePhaseCancelled: '已取消',
    workflowMarketplacePhaseChecking: '檢查更新中',
    workflowMarketplaceChangeAdded: '已新增',
    workflowMarketplaceChangeModified: '已修改',
    workflowMarketplaceChangeRemoved: '已移除',
    workflowMarketplaceChangeRenamed: '已重新命名',
    workflowMarketplaceSeverityBlocker: '阻擋項目',
    workflowMarketplaceSeverityAdvisory: '提醒',
    workflowMarketplaceDiagnosticLegacyLanguage: '工作流程使用寬鬆的舊版 Hermes 語言規則。',
    workflowMarketplaceDiagnosticLegacyIdleTimeout: '舊版閒置逾時會以秒為單位解讀。',
    workflowMarketplaceDiagnosticMissingProvider: '所需提供者無法使用。',
    workflowMarketplaceDiagnosticMissingRuntime: '所需執行環境無法使用。',
    workflowMarketplaceDiagnosticMissingSecret: '所需祕密無法使用。',
    workflowMarketplaceDiagnosticMissingService: '所需服務無法使用。',
    workflowMarketplaceDiagnosticMissingTool: '所需工具無法使用。',
    workflowMarketplaceDiagnosticUnknown: 'Hermes 回報了此版本尚無翻譯說明的相容性問題。',
    workflowMarketplaceDiagnosticTechnicalDetails: '技術詳細資料',
    workflowMarketplaceDiagnosticCode: '診斷代碼',
    workflowMarketplaceDiagnosticMessage: '後端訊息',
    workflowMarketplaceFileChange: (kind, path) => `變更 ${kind}：${path}`,
    workflowMarketplaceRenamedFrom: path => `原名 ${path}`,
    workflowMarketplacePackageResources: '套件資源',
    workflowMarketplaceWorkflowRisks: '工作流程風險',
    workflowMarketplaceDefinitionPath: '定義',
    workflowMarketplaceCompanionPath: '伴隨檔案',
    workflowMarketplaceRiskDigest: '風險摘要',
    workflowMarketplaceShellScriptNodes: 'Shell 或指令碼節點',
    workflowMarketplaceScriptResources: '指令碼資源',
    workflowMarketplaceCommandNodes: '命令節點',
    workflowMarketplaceCommandResources: '命令資源',
    workflowMarketplaceLocalMcp: '本機 MCP 伺服器',
    workflowMarketplaceRemoteMcp: '遠端 MCP 伺服器',
    workflowMarketplaceMcpDefinitions: 'MCP 定義',
    workflowMarketplaceMcpResourceFiles: 'MCP 資源檔案',
    workflowMarketplaceRequestedSkills: '要求的技能',
    workflowMarketplaceOutwardActions: '對外操作節點',
    workflowMarketplaceApprovalNodes: '核准節點',
    workflowMarketplaceRequiredSecrets: '所需密鑰',
    workflowMarketplaceWorkflowChanges: '工作流程成員變更',
    workflowMarketplaceRequirementChanges: '外部需求變更',
    workflowMarketplaceRiskChanges: '風險識別資訊變更',
    workflowMarketplaceCompatibilityChanges: '相容性變更',
    workflowMarketplaceAdded: '已新增',
    workflowMarketplaceRemoved: '已移除',
    workflowMarketplaceNoChanges: '沒有變更。',
    workflowMarketplaceInstalledTrustRequired: '已安裝 — 執行前需要信任',
    workflowMarketplaceUpdatedTrustRequired: version => `已更新至版本 ${version} — 執行前需要信任`,
    workflowMarketplaceReviewTrustAction: '審查信任',
    workflowMarketplaceInstallFailed: '安裝失敗。未安裝新內容。',
    workflowMarketplaceInstallCancelled: '安裝已取消。未安裝新內容。',
    workflowMarketplaceUpdateFailed: '更新失敗。',
    workflowMarketplaceUpdateCancelled: '更新已取消。',
    workflowMarketplaceVersionRemainsInstalled: version => `版本 ${version} 仍已安裝。`,
    workflowMarketplaceNothingInstalled: '未安裝新內容。',
    workflowMarketplaceOperationStatusLost: '操作狀態已過期。請重新整理套件狀態或重新準備。',
    workflowMarketplaceOperationStatusUnavailable: '操作狀態暫時無法使用。請重試。',
    workflowMarketplaceReviewStale: '審查已過期或變更。請重新準備審查後繼續。',
    workflowMarketplacePackageCurrent: version => `版本 ${version} 已是最新。未安裝更新。`,
    workflowMarketplaceTrustAllWorkflows: '所有工作流程',
    workflowMarketplaceTrustOneWorkflow: '單一工作流程',
    workflowMarketplaceSelectWorkflow: '選取工作流程',
    workflowMarketplaceTrustNotGranted: '未授予信任。請重新準備信任審查。',
    workflowMarketplaceTrustGranted: '已為審查過的已安裝內容授予信任。',
    workflowMarketplaceRemovalScope: '僅移除此命名空間中的套件、來源紀錄及由此安裝授予的信任。',
    workflowMarketplaceRemovalPreserves: '來源定義、其他套件、獨立工作流程以及獨立或手動授予的信任會保留。',
    workflowMarketplacePackageRemoved: '套件已移除。',
    workflowMarketplaceRemovalFailed: '移除失敗。',
    workflowMarketplaceRemovalCancelled: '移除已取消。',
    workflowMarketplaceInstallPackage: '安裝套件',
    workflowMarketplaceUpdatePackage: '更新套件',
    workflowMarketplaceCheckUpdates: '檢查更新',
    workflowMarketplaceRemovePackage: '移除套件',
    workflowMarketplaceInstalledPackageLabel: identifier => `已安裝套件 ${identifier}`,
    workflowMarketplaceLifecycleUnavailable: '升級 Hermes 以管理已安裝的工作流程套件。',
    workflows: '工作流程',
    workflowViews: '工作流程檢視',
    workflowCatalog: '工作流程目錄',
    workflowCatalogLoading: '正在載入工作流程目錄',
    workflowCatalogErrorTitle: '無法載入工作流程',
    workflowCatalogErrorDescription: '工作流程目錄暫時無法使用。',
    workflowCatalogRetry: '重試',
    workflowCatalogEmptyTitle: '未安裝工作流程',
    workflowCatalogEmptyDescription: '安裝工作流程套件後，它將顯示在這裡。',
    workflowCatalogDocs: '工作流程文件',
    workflowCatalogPartialLabel: '部分工作流程目錄',
    workflowCatalogPartialDescription: '只能載入工作流程目錄的一部分。',
    workflowCatalogCapacityError: '已超出目錄容量',
    workflowCatalogInvalidDefinition: '工作流程定義無效',
    workflowCatalogFilter: '篩選工作流程',
    workflowCatalogGoToPage: page => `前往工作流程第 ${page} 頁`,
    workflowCatalogNoMatchTitle: '沒有符合篩選條件的工作流程',
    workflowCatalogRange: (start, end, total) => `${start}–${end} / 共 ${total} 個工作流程`,
    workflowCatalogRowsPerPage: '每頁行數',
    workflowColumnName: '名稱',
    workflowColumnVersion: '版本',
    workflowColumnDescription: '說明',
    workflowColumnTrust: '信任',
    workflowColumnInputs: '輸入',
    workflowColumnSource: '來源',
    workflowColumnActions: '操作',
    workflowTrusted: '可信',
    workflowUntrusted: '不可信',
    workflowVerifiedBundle: '已驗證套件',
    workflowIncompatible: '不相容',
    workflowLanguage: '工作流程語言',
    workflowLanguageArchon: 'Archon 2026-07',
    workflowLanguageLegacy: '舊版語意',
    workflowLanguageLegacyDescription: '現有 Hermes 行為會保留。遷移至 Archon 2026-07 前，請檢查相容性結果。',
    workflowLanguageNormalizer: '正規化版本',
    workflowLanguageDigest: '正規化摘要',
    workflowDependencies: '工作流程依賴項',
    workflowDependencySources: '依賴項來源',
    workflowDependencyPrecedence: '優先順序',
    workflowDependencyPackages: '依賴套件',
    workflowExpandedNodes: '展開的節點',
    workflowExpandedEdges: '展開的邊',
    workflowIncludeDepth: '包含深度',
    workflowCompositeDigest: '複合摘要',
    workflowIgnoredPolicies: '已忽略的子原則',
    workflowIgnoredPolicyField: field => `已忽略：${field}`,
    workflowRequiresAi: '透過已設定的模型供應商執行 AI 推論',
    workflowNoInputs: '無輸入',
    workflowInputCount: count => `${count} 個輸入`,
    workflowSourceProfile: '設定檔',
    workflowSourceProject: '專案',
    workflowSourceBundled: '內建展示',
    workflowView: '檢視',
    workflowViewTitle: workflow => `檢視 ${workflow}`,
    workflowViewDescription: '在不變更或啟動工作流程的情況下檢視詳細資料。',
    workflowViewDiagram: '流程圖',
    workflowViewDefinition: '定義',
    workflowViewLoading: '正在載入工作流程詳細資料',
    workflowViewErrorTitle: '無法載入工作流程詳細資料',
    workflowViewErrorDescription: '無法載入工作流程詳細資料。請再試一次。',
    workflowViewNotFound: '此工作流程已不在安裝清單中。',
    workflowViewDiagramTooLarge: '工作流程過大，已省略流程圖並顯示大綱。',
    workflowViewDiagramOmitted: '已省略流程圖並顯示大綱。',
    workflowViewDefinitionTitle: '正規化定義',
    workflowViewDefinitionCaption: '這是已遮蔽敏感資訊的正規化定義，並非磁碟上的原始檔。',
    workflowViewCopyDefinition: '複製定義',
    workflowViewRunLoading: '工作流程就緒狀態載入完成前無法執行。',
    workflowViewRunError: '成功載入工作流程就緒狀態前無法執行。',
    workflowRun: '執行',
    workflowRunUnavailable: '無法執行',
    workflowRunUnsupportedInputs: '此工作流程使用不支援的輸入欄位，因此無法執行。',
    workflowRunShowcaseFromCli: '請從 CLI 執行此內建展示。',
    workflowRunShowcaseVerificationFailed: '無法驗證內建展示，因此未啟動。',
    ...
    workflowRunPreflightLoading: '正在檢查工作流程是否可執行',
    workflowRunPreflightErrorTitle: '無法檢查此工作流程',
    workflowRunPreflightErrorDescription: '無法檢查工作流程是否可執行。',
    workflowRunTrust: '信任結論',
    workflowRunRisk: '風險摘要',
    workflowRunInputs: '輸入',
    workflowRunInputBytes: (used, limit) => `${used} / ${limit} 位元組`,
    workflowRunInputTooLarge: (input, limit) => `${input} 不能超過 ${limit} 位元組。`,
    workflowRunBundledFixture: '內建測試檔案',
    workflowRunStart: '啟動工作流程',
    workflowRunAt: '執行時間',
    workflowRunLater: '稍後執行',
    workflowRunLaterDescription: '在所選本地日期與時間一次性執行此工作流程。',
    workflowRunScheduleInvalid: '請選擇未來的日期與時間。',
    workflowScheduled: '已排程',
    workflowScheduledAt: '預定執行時間',
    workflowScheduledLocal: '本地時間',
    workflowScheduledCanonical: '標準 UTC',
    workflowRunRetry: '重試',
    workflowRunStarted: '已啟動',
    workflowRunAlreadyRunning: '已在執行 — 正在顯示該次執行',
    workflowRunConflict: '建立此次執行意圖後，輸入已變更。請關閉檢查視窗並重試。',
    workflowRunCatalogSourceInvalid: '此工作流程來源已無法使用。請關閉檢查視窗並重新選取。',
    workflowRunCoordinatorUnavailable: '背景協調器未執行 — 請稍後重試。',
    workflowRunIncompatible: '此工作流程與目前的 Hermes 執行環境不相容，無法啟動。',
    workflowRunProviderAuthorityUnavailable: '提供者就緒狀態已變更，請在啟動前重新檢查。',
    workflowProviderReadiness: '提供者就緒狀態',
    workflowProviderAuthorityDigest: '權威摘要',
    workflowProviderCapabilityLevel: '能力層級',
    workflowProviderRoute: (node, provider, model) => `${node}: ${provider} · ${model}`,
    workflowRunNetworkError: '連線失敗，無法啟動此次執行。',
    workflowRunProfileUnavailable: '執行已啟動，但無法開啟其設定檔。請重試以找到該執行。',
    workflowRunValidationError: '工作流程輸入未被接受。',
    workflowRunRequiredInput: input => `${input} 為必填欄位。`,
    workflowRunUnsupportedCommand: workflow =>
      `應用程式尚不支援此工作流程的輸入 — 請使用 hermes workflow run ${workflow} 執行。`,
    activeBoard: '作用中看板',
    ...
    kanban: '看板',
    needsAttention: '需要處理',
    workflowAttention: '需要處理的工作流程',
    openWorkflowRun: workflow => `開啟執行 ${workflow}`,
    attentionAge: (count, unit) => `${count}${unit === 'day' ? '天' : unit === 'hour' ? '小時' : '分鐘'}前`,
    status: '狀態',
    health: '健康狀態',
    graphProgress: '圖形進度',
    ...
    recovery: '復原',
    noEvidence: '沒有已記錄的證據',
    artifactOutputType: '輸出類型',
    artifactMediaType: '媒體類型',
    artifactProducer: '產生節點',
    artifactWinningAttempt: '最終採用的嘗試',
    artifactSize: '大小',
    artifactSizeBytes: size => `${size} 位元組`,
    artifactSha256: 'SHA-256',
    artifactSchemaFingerprint: 'Schema 指紋',
    artifactProducedAt: '產生時間',
    artifactSession: '工作階段',
    artifactIntegrity: '完整性',
    artifactRecovery: '復原狀態',
    artifactUnavailable: '無法使用',
    artifactPreview: '預覽產物',
    artifactDownload: '下載產物',
    artifactDownloading: '正在下載產物',
    artifactLabel: identity => `產物：${identity}`,
    artifactPreviewFor: identity => `預覽產物：${identity}`,
    artifactDownloadFor: identity => `下載產物：${identity}`,
    artifactDownloadingFor: identity => `正在下載產物：${identity}`,
    artifactDownloadCancelled: '下載已取消。',
    artifactDownloadErrorTitle: '無法下載產物',
    artifactDownloadErrorDescription: '下載失敗，請再試一次。',
    artifactPreviewRegion: '產物預覽',
    artifactPreviewLoading: '正在載入產物預覽',
    artifactPreviewErrorTitle: '無法載入產物預覽',
    artifactPreviewErrorDescription: '產物中繼資料仍然可用。你可以重試或下載產物。',
    artifactPreviewIncomplete: '受限預覽並不完整。請下載產物以查看完整內容。',
    artifactTextPreviewTruncated: '目前顯示受限預覽。請下載產物以查看完整輸出。',
    artifactDownloadOnly: '此媒體類型無法預覽，但仍可下載。',
    acceptResult: '接受結果',
    continueWithFeedback: '提供意見並繼續',
    feedback: '意見',
    provideInput: '提供輸入',
    inputValue: '輸入值',
    reconcile: '核對結果',
    reconciliationOutcome: '已觀察到的結果',
    confirmedSucceeded: '確認成功',
    confirmedFailed: '確認失敗',
    safeToRetry: '可以重試',
    approve: '核准',
    reject: '拒絕',
    cancel: '取消',
    ...
    loadMore: '載入更多',
    workflowUnavailable: '工作流程資料無法使用。請檢查連線後再試一次。',
