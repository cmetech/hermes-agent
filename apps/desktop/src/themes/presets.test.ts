...
// The pre-GitHub Nous palette stays available as nous-alt; the branded default
// still uses its current palette rather than the retired one.
describe('nous-alt is the retired Nous, not the default', () => {
  it('is registered under its own name and is not the branded default', () => {
