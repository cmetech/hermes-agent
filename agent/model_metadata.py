...
def is_anthropic_bedrock_model(model_id: str) -> bool:
    ...
    # Regional inference-profile prefixes (kept in sync with the upstream
    # Bedrock-adapter allowlist so prospective, side-effect-free classification
    # here recognizes every region the adapter path does).
    for prefix in (
