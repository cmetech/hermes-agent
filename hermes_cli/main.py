...
def _print_fast_version_info() -> None:
    ...
    from hermes_constants import version_agent_label
...
def _run_npm_install_deterministic(
    ...
    *,
    ...
    if lockfile.exists():
        ...
        # `--include=dev` (upstream PR #65595) ensures web devDeps still install.
        install_cmd = [npm, "install", "--no-package-lock", "--include=dev", *extra_args]
