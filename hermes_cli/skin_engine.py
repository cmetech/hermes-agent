...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "loop24": {
        "name": "loop24",
        "description": "LOOP24 — gold on black brand theme",
        "colors": {
        ...
        "branding": {
            "agent_name": "LOOP24",
            "welcome": "Welcome to LOOP24! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ LOOP24 ",
            "prompt_symbol": "❯",
...
def init_skin_from_config(config: dict) -> None:
    ...
    if not isinstance(display, dict):
        display = {}
    skin_name = display.get("skin", "loop24")
    if isinstance(skin_name, str) and skin_name.strip():
        set_active_skin(skin_name.strip())
    else:
        set_active_skin("loop24")
