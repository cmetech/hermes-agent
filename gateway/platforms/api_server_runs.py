...
async def _handle_runs(
    ...
    *,
    ...
    _openai_error = _api_server._openai_error
    _parse_api_tool_operation = _api_server._parse_api_tool_operation
            ...
            def _run_sync():
                ...
                with self._profile_scope(request_profile):
                    try:
                        ...
                        if tool_operation_context is not None:
                            _api_server.validate_tool_choice_policy(
                                tool_operation_context.policy,
                                _api_server._effective_agent_tool_names(agent),
                            )
