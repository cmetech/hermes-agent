"""LOOP24 gateway provider profile.

Routes chat completions through the LOOP24 gateway (an OpenAI-compatible Go
...
loop24 = ProviderProfile(
    name="loop24",
    aliases=("loop24-gateway",),
    display_name="LOOP24 Gateway",
    description="LOOP24 gateway → Kilo (kiro-cli)",
